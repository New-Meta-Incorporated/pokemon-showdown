export const Pokedex: {[speciesid: string]: SpeciesData} = {
	...
	pidgeotto: {
		...
		name: "Pidgeotto",
		types: ["Normal", "Flying"],
		baseStats: {hp: 63, atk: 70, def: 55, spa: 70, spd: 50, spe: 81},
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks"},
		heightm: 1.1,
		weightkg: 30,
		color: "Brown",
	...
	pidgeot: {
		...
		name: "Pidgeot",
		types: ["Normal", "Flying"],
		baseStats: {hp: 83, atk: 100, def: 75, spa: 95, spd: 70, spe: 101},
		abilities: {0: "Keen Eye", 1: "Tangled Feet", H: "Big Pecks"},
		heightm: 1.5,
		weightkg: 39.5,
		color: "Brown",
	...
	pidgeotmega: {
		...
		forme: "Mega",
		types: ["Normal", "Flying"],
		baseStats: {hp: 83, atk: 100, def: 95, spa: 135, spd: 90, spe: 121},
	...
	fearow: {
		...
		name: "Fearow",
		types: ["Normal", "Flying"],
		baseStats: {hp: 65, atk: 107, def: 75, spa: 61, spd: 64, spe: 103},
	...
	ekans: {
		...
		abilities: {0: "Intimidate", 1: "Shed Skin", H: "Petrify"},
		heightm: 2,
		weightkg: 6.9,
		color: "Purple",
		evos: ["Arbok"],
	...
	arbok: {
		...
		name: "Arbok",
		types: ["Poison"],
		baseStats: {hp: 60, atk: 107, def: 89, spa: 65, spd: 89, spe: 90},
		abilities: {0: "Intimidate", 1: "Shed Skin", H: "Petrify"},
		heightm: 3.5,
		weightkg: 65,
		color: "Purple",
	...
	arboklokura: {
		...
		forme: "Lokura",
		types: ["Grass", "Water"],
		baseStats: {hp: 80, atk: 110, def: 100, spa: 60, spd: 80, spe: 70},
		abilities: {0: "Blood Sucker", 1: "Hydration", H: "Aroma Veil"},
		heightm: 3.0,
		weightkg: 45.5,
		color: "Green",
		prevo: "Ekans",
	...
	raichu: {
		...
		name: "Raichu",
		types: ["Electric"],
		baseStats: {hp: 60, atk: 95, def: 55, spa: 85, spd: 80, spe: 110},
		abilities: {0: "Static", H: "Lightning Rod"},
		heightm: 0.8,
		weightkg: 30,
		color: "Yellow",
	...
	raichualola: {
		...
		abilities: {0: "Surge Surfer" ,1: "Levitate"},
		heightm: 0.7,
		weightkg: 21,
		color: "Brown",
		prevo: "Pikachu",
	...
	ninetales: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 73, atk: 57, def: 75, spa: 91, spd: 100, spe: 109},
		abilities: {0: "Flash Fire", H: "Drought"},
		heightm: 1.1,
		weightkg: 19.9,
		color: "Yellow",
	...
	wigglytuff: {
		...
		types: ["Normal", "Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 140, atk: 70, def: 65, spa: 85, spd: 75, spe: 40},
		...
		evoItem: "Moon Stone",
		eggGroups: ["Fairy"],
		otherFormes: ["Wigglytuff-Johto"],
        formeOrder: ["Wigglytuff", "Wigglytuff-Johto"],
	},
	wigglytuffjohto:{
		num: 40,
		...
		types: ["Normal", "Steel"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 130, atk: 85, def: 80, spa: 65, spd: 75, spe: 40},
		abilities: {0: "Heavy Metal", 1: "Clear Body", H: "Bulletproof"},
		heightm: 1,
		weightkg: 430,
		color: "Gray",
		prevo: "Jigglypuff",
	...
	zubat: {
		...
		abilities: {0: "Inner Focus", 1: "Blood Sucker", H: "Infiltrator"},
		heightm: 0.8,
		weightkg: 7.5,
		color: "Purple",
		evos: ["Golbat"],
	...
	paras: {
		...
		evos: ["Parasect"],
		eggGroups: ["Bug", "Grass"],
		otherFormes: ["Paras-Orre"],
		formeOrder: ["Paras", "Paras-Orre"],
	},
	parasect: {
		num: 47,
		name: "Parasect",
		types: ["Grass", "Bug"],
		baseStats: {hp: 70, atk: 100, def: 90, spa: 60, spd: 90, spe: 30},
		abilities: {0: "Effect Spore", 1: "Dry Skin", H: "Parasite"},
		heightm: 1,
		weightkg: 29.5,
		color: "Red",
		prevo: "Paras",
		evoLevel: 24,
		eggGroups: ["Bug", "Grass"],
		otherFormes: ["Parasect-Orre"],
		formeOrder: ["Parasect", "Parasect-Orre"],
	},
	parasorre: {
		num: 46,
		name: "Paras-Orre",
		...
		types: ["Poison", "Bug"],
		baseStats: {hp: 35, atk: 70, def: 55, spa: 45, spd: 55, spe: 25},
		abilities: {0: "Effect Spore", 1: "Poison Touch", H: "Merciless"},
		heightm: 0.3,
		weightkg: 5.4,
		color: "Purple",
		evos: ["Parasect-Orre"],
	...
	parasectorre: {
		...
		forme: "Orre",
		types: ["Poison", "Dark"],
		baseStats: {hp: 70, atk: 115, def: 55, spa: 65, spd: 80, spe: 20},
		abilities: {0: "Effect Spore", 1: "Toxic Intake", H: "Merciless"},
		heightm: 1,
		weightkg: 29.5,
		color: "Purple",
		prevo: "Paras-Orre",
	...
	paraspore: {
		...
		name: "Paraspore",
		types: ["Poison", "Dark"],
		baseStats: {hp: 75, atk: 120, def: 80, spa: 85, spd: 90, spe: 65},
		abilities: {0: "Effect Spore", 1: "Toxic Intake", H: "Merciless"},
		heightm: 1.7,
		weightkg: 55.6,
		color: "Purple",
	...
	venomoth: {
		...
		name: "Venomoth",
		types: ["Bug", "Poison"],
		baseStats: {hp: 70, atk: 65, def: 60, spa: 100, spd: 75, spe: 90},
	...
	golduck: {
		...
		abilities: {0: "Fortitude", 1: "Cloud Nine", H: "Swift Swim"},
		heightm: 1.7,
		weightkg: 76.6,
		color: "Blue",
		prevo: "Psyduck",
	...
	mankey: {
		...
		abilities: {0: "Vital Spirit", 1: "Moxie", H: "Defiant"},
		heightm: 0.5,
		weightkg: 28,
		color: "Brown",
		evos: ["Primeape"],
	...
	machamp: {
		...
		types: ["Fighting"],
		genderRatio: {M: 0.75, F: 0.25},
		baseStats: {hp: 90, atk: 130, def: 80, spa: 65, spd: 85, spe: 50},
		abilities: {0: "Guts", 1: "No Guard", H: "Chain Striker"},
		heightm: 1.6,
		weightkg: 130,
		color: "Gray",
		prevo: "Machoke",
	...
	bellsprout: {
		...
		abilities: {0: "Chlorophyll", 1: "Toxic Rush", H: "Gluttony"},
		heightm: 0.7,
		weightkg: 4,
		color: "Green",
		evos: ["Weepinbell"],
	...
	golem: {
		...
		name: "Golem",
		types: ["Rock", "Ground"],
		baseStats: {hp: 90, atk: 130, def: 120, spa: 55, spd: 75, spe: 55},
		abilities: {0: "Rock Head", 1: "Sturdy", H: "Sand Veil"},
		heightm: 1.4,
		weightkg: 300,
		color: "Brown",
	...
	ponyta: {
		...
		abilities: {0: "Conflagrant", 1: "Flash Fire", H: "Flame Body"},
		heightm: 1,
		weightkg: 30,
		color: "Yellow",
		evos: ["Rapidash"],
	...
	rapidash: {
		...
		name: "Rapidash",
		types: ["Fire"],
		baseStats: {hp: 72, atk: 115, def: 70, spa: 80, spd: 80, spe: 110},
		abilities: {0: "Conflagrant", 1: "Flash Fire", H: "Flame Body"},
		heightm: 1.7,
		weightkg: 95,
		color: "Yellow",
	...
	farfetchd: {
		...
		abilities: {0: "Blade Master", 1: "Inner Focus", H: "Defiant"},
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
	...
	farfetchdgalar: {
		...
		abilities: {0: "Steadfast", 1: "Blade Master", H: "Scrappy"},
		heightm: 0.8,
		weightkg: 15,
		color: "Brown",
		evos: ["Sirfetch\u2019d"],
	...
	doduo: {
		...
		name: "Doduo",
		types: ["Normal", "Flying"],
		baseStats: {hp: 35, atk: 85, def: 45, spa: 35, spd: 35, spe: 85},
		...
		evos: ["Dodrio"],
		eggGroups: ["Flying"],
		otherFormes: ["Doduo-Sinnoh"],
        formeOrder: ["Doduo", "Doduo-Sinnoh"],
	},
	dodrio: {
		num: 85,
		name: "Dodrio",
		...
		evoLevel: 31,
		eggGroups: ["Flying"],
		otherFormes: ["Dodrio-Sinnoh"],
        formeOrder: ["Dodrio", "Dodrio-Sinnoh"],
	},
	doduosinnoh: {
		num: 84,
		name: "Doduo-Sinnoh",
        ...
        forme: "Sinnoh",
		types: ["Water", "Flying"],
		baseStats: {hp: 35, atk: 35, def: 45, spa: 85, spd: 35, spe: 85},
		abilities: {0: "Swift Swim", 1: "Early Bird", H: "Liquid Voice"},
		heightm: 1.4,
		weightkg: 39.2,
		color: "Blue",
		evos: ["Dodrio-Sinnoh"],
	...
	dodriosinnoh: {
        ...
        forme: "Sinnoh",
		types: ["Water", "Flying"],
		baseStats: {hp: 60, atk: 60, def: 70, spa: 110, spd: 60, spe: 110},
		abilities: {0: "Swift Swim", 1: "Early Bird", H: "Liquid Voice"},
		heightm: 1.8,
		weightkg: 85.2,
		color: "Blue",
	...
	dewgong: {
		...
		name: "Dewgong",
		types: ["Water", "Ice"],
		baseStats: {hp: 90, atk: 90, def: 90, spa: 90, spd: 95, spe: 70},
		abilities: {0: "Thick Fat", 1: "Hydration", H: "Ice Body"},
		heightm: 1.7,
		weightkg: 120,
		color: "White",
	...
	gastly: {
		...
		abilities: {0: "Levitate", 1: "Poison Cloak", H: "Cursed Body"},
		heightm: 1.3,
		weightkg: 0.1,
		color: "Purple",
		evos: ["Haunter"],
	...
	gengar: {
		...
		abilities: {0: "Cursed Body", 1: "Poison Cloak", H: "Levitate"},
		heightm: 1.5,
		weightkg: 40.5,
		color: "Purple",
		prevo: "Haunter",
		evoType: "trade",
		eggGroups: ["Amorphous"],
		otherFormes: ["Gengar-Mega", "Gengar-Alola"],
	...
	gengaralola: {
		...
		forme: "Alola",
		types: ["Dark", "Cosmic"],
		baseStats: {hp: 65, atk: 65, def: 110, spa: 115, spd: 85, spe: 60},
		abilities: {0: "Radioactive", 1: "Levitate", H: "Magic Bounce"},
		heightm: 1.5,
		weightkg: 40.5,
		color: "Purple",
		prevo: "Haunter",
	...
	mezmer: {
		...
		name: "Mezmer",
		types: ["Psychic", "Ghost"],
		baseStats: {hp: 85, atk: 83, def: 90, spa: 93, spd: 155, spe: 34},
		abilities: {0: "Magic Guard", 1: "Forewarn", H: "Inner Focus"},
		heightm: 2.1,
		weightkg: 34.2,
		color: "Yellow",
		prevo: "Hypno",
	...
	kingler: {
		...
		name: "Kingler",
		types: ["Water"],
		baseStats: {hp: 70, atk: 130, def: 130, spa: 50, spd: 50, spe: 75},
		abilities: {0: "Hyper Cutter", 1: "Shell Armor", H: "Sheer Force"},
		heightm: 1.3,
		weightkg: 60,
		color: "Red",
	...
	electrode: {
		...
		types: ["Electric"],
		gender: "N",
		baseStats: {hp: 60, atk: 50, def: 70, spa: 95, spd: 80, spe: 160},
		abilities: {0: "Soundproof", 1: "Static", H: "Aftermath"},
		heightm: 1.2,
		weightkg: 66.6,
		color: "Red",
	...
	exeggcute: {
		...
		abilities: {0: "Chlorophyll", 1: "Twinned", H: "Harvest"},
		heightm: 0.4,
		weightkg: 2.5,
		color: "Pink",
	...
	exeggutoralola: {
		...
		abilities: {0: "Frisk", 1: "Twinned", H: "Harvest"},
		heightm: 10.9,
		weightkg: 415.6,
		color: "Yellow",
		prevo: "Exeggcute",
	...
	cubone: {
		...
		abilities: {0: "Rock Head", 1: "Lightning Rod", H: "Family Bonds"},
		heightm: 0.4,
		weightkg: 6.5,
		color: "Brown",
	...
	marowakalola: {
		...
		types: ["Fire", "Ghost"],
		baseStats: {hp: 60, atk: 80, def: 110, spa: 50, spd: 80, spe: 45},
		abilities: {0: "Family Bonds", 1: "Lightning Rod", H: "Rock Head"},
		heightm: 1,
		weightkg: 34,
		color: "Purple",
		prevo: "Cubone",
	...
	hitmonlee: {
		...
		abilities: {0: "Kicker", 1: "Reckless", H: "Unburden"},
		heightm: 1.5,
		weightkg: 49.8,
		color: "Brown",
		prevo: "Tyrogue",
	...
	koffing: {
		...
		abilities: {0: "Levitate", 1: "Neutralizing Gas", H: "Toxic Wasteland"},
		heightm: 0.6,
		weightkg: 1,
		color: "Purple",
	...
	weezing: {
		...
		name: "Weezing",
		types: ["Poison"],
		baseStats: {hp: 65, atk: 85, def: 120, spa: 90, spd: 70, spe: 60},
		abilities: {0: "Levitate", 1: "Neutralizing Gas", H: "Toxic Wasteland"},
		heightm: 1.2,
		weightkg: 9.5,
		color: "Purple",
	...
	tangela: {
		...
		abilities: {0: "Chlorophyll", 1: "Gordian Knot", H: "Regenerator"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
		evos: ["Tangrowth"],
	...
	kangaskhan: {
		...
		abilities: {0: "Family Bonds", 1: "Scrappy", H: "Inner Focus"},
		heightm: 2.2,
		weightkg: 80,
		color: "Brown",
		eggGroups: ["Monster"],
	...
	horsea: {
		...
		abilities: {0: "Swift Swim", 1: "Sniper", H: "Hydration"},
		heightm: 0.4,
		weightkg: 8,
		color: "Blue",
		evos: ["Seadra"],
	...
	seadra: {
		...
		abilities: {0: "Poison Point", 1: "Sniper", H: "Hydration"},
		heightm: 1.2,
		weightkg: 25,
		color: "Blue",
		prevo: "Horsea",
	...
	seaking: {
		...
		name: "Seaking",
		types: ["Water"],
		baseStats: {hp: 85, atk: 107, def: 70, spa: 65, spd: 85, spe: 73},
		abilities: {0: "Swift Swim", 1: "Water Veil", H: "Lightning Rod"},
		heightm: 1.3,
		weightkg: 39,
		color: "Red",
	...
	jynx: {
		...
		abilities: {0: "Oblivious", 1: "Lovely Lips", H: "Dry Skin"},
		heightm: 1.4,
		weightkg: 40.6,
		color: "Red",
		prevo: "Smoochum",
	...
	electabuzz: {
		...
		abilities: {0: "Static", 1: "Dynamo", H: "Vital Spirit"},
		heightm: 1.1,
		weightkg: 30,
		color: "Yellow",
		prevo: "Elekid",
	...
	magmar: {
		...
		abilities: {0: "Flame Body", 1: "Conflagrant", H: "Vital Spirit"},
		heightm: 1.3,
		weightkg: 44.5,
		color: "Red",
		prevo: "Magby",
	...
	pinsir: {
		...
		color: "Brown",
		eggGroups: ["Bug"],
		otherFormes: ["Pinsir-Mega", "Pinsir-Oblivia", "Pinsir-Oblivia-Mega"],
		formeOrder: ["Pinsir", "Pinsir-Mega", "Pinsir-Oblivia", "Pinsir-Oblivia-Mega"],
	},
	pinsiroblivia: {
		num: 127,
		name: "Pinsir-Oblivia",
    forme: "Oblivia",
		types: ["Electric", "Bug"],
		baseStats: {hp: 55, atk: 114, def: 96, spa: 66, spd: 70, spe: 94},
	...
	pinsirobliviamega: {
		...
		baseStats: {hp: 55, atk: 145, def: 100, spa: 70, spd: 90, spe: 140},
	...
	pinsirmega: {
		...
		forme: "Mega",
		types: ["Bug", "Flying"],
		baseStats: {hp: 65, atk: 155, def: 120, spa: 55, spd: 95, spe: 110},
		abilities: {0: "Aerilate"},
		heightm: 1.7,
		weightkg: 59,
		color: "Brown",
	...
	taurosgalar: {
		...
		types: ["Steel", "Ghost"],
		gender: "M",
		baseStats: {hp: 110, atk: 40, def: 95, spa: 100, spd: 75, spe: 75},
		abilities: {0: "Sheer Force", 1: "Regenerator", H: "Clear Body"},
		heightm: 1.4,
		weightkg: 88.4,
		color: "Grey",
		eggGroups: ["Field"],
	...
	magikarp: {
		...
		abilities: {0: "Swift Swim", 1: "Oblivious", H: "Rattled"},
		heightm: 0.9,
		weightkg: 10,
		color: "Red",
		evos: ["Gyarados"],
	...
	lapras: {
		...
		name: "Lapras",
		types: ["Water", "Ice"],
		baseStats: {hp: 130, atk: 85, def: 85, spa: 85, spd: 95, spe: 60},
		abilities: {0: "Water Absorb", 1: "Liquid Voice", H: "Hydration"},
		heightm: 2.5,
		weightkg: 220,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
		otherFormes: ["Lapras-Alola"],
        formeOrder: ["Lapras", "Lapras-Alola"],
	...
	laprasalola: {
        ...
        forme: "Alola",
		types: ["Water", "Rock"],
		baseStats: {hp: 130, atk: 65, def: 95, spa: 85, spd: 95, spe: 70},
		abilities: {0: "Herbivore", 1: "Swift Swim", H: "Chlorophyll"},
		heightm: 2.5,
		weightkg: 220,
		color: "Green",
		eggGroups: ["Monster", "Water 1"],
	...
	laprasgmax: {
		...
		abilities: {0: "Water Absorb", 1: "Liquid Voice", H: "Ice Scales"},
		heightm: 24,
		weightkg: 0,
		color: "Blue",
		eggGroups: ["Monster", "Water 1"],
	...
	eevee: {
		...
		weightkg: 6.5,
		color: "Brown",
		evos: ["Vaporeon", "Jolteon", "Flareon", "Espeon", "Umbreon", "Leafeon", "Glaceon", "Sylveon", "Lustreon"],
		eggGroups: ["Field"],
	...
	jolteon: {
		...
		abilities: {0: "Volt Absorb", 1: "Intimidate", H: "Quick Feet"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: "Eevee",
	...
	flareon: {
		...
		abilities: {0: "Flash Fire", 1: "Conflagrant", H: "Guts"},
		heightm: 0.9,
		weightkg: 25,
		color: "Red",
		prevo: "Eevee",
	...
	omastar: {
		...
		types: ["Rock", "Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 60, def: 125, spa: 115, spd: 75, spe: 65},
		abilities: {0: "Swift Swim", 1: "Shell Armor", H: "Weak Armor"},
		heightm: 1,
		weightkg: 35,
		color: "Blue",
	...
	kabutops: {
		...
		types: ["Rock", "Water"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 125, def: 105, spa: 65, spd: 70, spe: 85},
		abilities: {0: "Swift Swim", 1: "Blade Master", H: "Technician"},
		heightm: 1.3,
		weightkg: 40.5,
		color: "Brown",
		prevo: "Kabuto",
	...
	articunogalar: {
		...
		abilities: {0: "Competitive", 1: "Daunt"},
		heightm: 1.7,
		weightkg: 50.9,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	moltresgalar: {
		...
		abilities: {0: "Berserk", H: "Cursed Body"},
		heightm: 2,
		weightkg: 66,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	mewtwo: {
		...
		abilities: {0: "Pressure", 1: "Daunt", H: "Unnerve"},
		heightm: 2,
		weightkg: 122,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	chikorita: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 55, atk: 29, def: 65, spa: 58, spd: 65, spe: 45},
		abilities: {0: "Overgrow", 1: "Flower Veil", H: "Leaf Guard"},
		heightm: 0.9,
		weightkg: 6.4,
		color: "Green",
		evos: ["Bayleef"],
	...
	bayleef: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 70, atk: 42, def: 80, spa: 73, spd: 80, spe: 60},
		abilities: {0: "Overgrow", 1: "Flower Veil", H: "Leaf Guard"},
		heightm: 1.2,
		weightkg: 15.8,
		color: "Green",
	...
	meganium: {
		...
		types: ["Grass"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 90, atk: 52, def: 110, spa: 103, spd: 110, spe: 60},
		abilities: {0: "Overgrow", 1: "Flower Veil", H: "Leaf Guard"},
		heightm: 1.8,
		weightkg: 100.5,
		color: "Green",
	...
	cyndaquil: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 39, atk: 47, def: 40, spa: 65, spd: 48, spe: 70},
		abilities: {0: "Blaze", 1: "White Smoke", H: "Flash Fire"},
		heightm: 0.5,
		weightkg: 7.9,
		color: "Yellow",
		evos: ["Quilava"],
	...
	quilava: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 58, atk: 59, def: 55, spa: 85, spd: 63, spe: 85},
		abilities: {0: "Blaze", 1: "White Smoke", H: "Flash Fire"},
		heightm: 0.9,
		weightkg: 19,
		color: "Yellow",
	...
	typhlosion: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 79, def: 75, spa: 114, spd: 83, spe: 105},
		abilities: {0: "Blaze", 1: "White Smoke", H: "Flash Fire"},
		heightm: 1.7,
		weightkg: 79.5,
		color: "Yellow",
	...
	furret: {
		...
		name: "Furret",
		types: ["Normal"],
		baseStats: {hp: 90, atk: 76, def: 70, spa: 45, spd: 65, spe: 101},
	...
	ariados: {
		...
		name: "Ariados",
		types: ["Bug", "Poison"],
		baseStats: {hp: 85, atk: 110, def: 85, spa: 60, spd: 85, spe: 50},
		abilities: {0: "Swarm", 1: "Poison Touch", H: "Paralyzing Venom"},
		heightm: 1.1,
		weightkg: 33.5,
		color: "Red",
		prevo: "Spinarak",
	...
	crobatmega: {
		...
		forme: "Mega",
		types: ["Poison", "Flying"],
		baseStats: {hp: 85, atk: 130, def: 95, spa: 70, spd: 95, spe: 160},
		abilities: {0: "Envious"},
		heightm: 1.8,
		weightkg: 77,
		color: "Purple",
	...
	lanturn: {
		...
		name: "Lanturn",
		types: ["Water", "Light"],
		baseStats: {hp: 125, atk: 58, def: 80, spa: 85, spd: 95, spe: 67},
		abilities: {0: "Volt Absorb", 1: "Illuminate", H: "Water Absorb"},
		heightm: 1.2,
		weightkg: 22.5,
		color: "Blue",
	...
	togepi: {
		...
		abilities: {0: "Enthusiasm", 1: "Serene Grace", H: "Super Luck"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "White",
		evos: ["Togetic"],
	...
	flaaffy: {
		...
		name: "Flaaffy",
		types: ["Electric", "Light"],
		baseStats: {hp: 80, atk: 55, def: 65, spa: 95, spd: 75, spe: 45},
		abilities: {0: "Static", 1: "Thunder Delight", H: "Illuminate"},
		heightm: 0.8,
		weightkg: 13.3,
		color: "Pink",
	...
	mareepfiore: {
		...
		forme: "Fiore",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 45, atk: 40, def: 40, spa: 75, spd: 60, spe: 75},
		abilities: {0: "Aerilate", 1: "Pixilate", H: "Enchantment"},
		heightm: 0.6,
		weightkg: 7.8,
		color: "Pink",
		evos: ["Flaaffy-Fiore"],
	...
	flaaffyfiore: {
		...
		forme: "Fiore",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 60, atk: 55, def: 55, spa: 90, spd: 70, spe: 85},
		abilities: {0: "Aerilate", 1: "Pixilate", H: "Enchantment"},
		heightm: 0.8,
		weightkg: 13.3,
		color: "Pink",
	...
	ampharosfiore: {
		...
		forme: "Fiore",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 80, atk: 65, def: 65, spa: 120, spd: 70, spe: 110},
		abilities: {0: "Aerilate", 1: "Pixilate", H: "Enchantment"},
		heightm: 1.4,
		weightkg: 61.5,
		color: "Pink",
	...
	marill: {
		...
		name: "Marill",
		types: ["Water", "Fairy"],
		baseStats: {hp: 70, atk: 25, def: 60, spa: 25, spd: 60, spe: 40},
	...
	sudowoodo: {
		...
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Imitation"},
		heightm: 1.2,
		weightkg: 38,
		color: "Brown",
		prevo: "Bonsly",
	...
	politoed: {
		...
		name: "Politoed",
		types: ["Water"],
		baseStats: {hp: 100, atk: 65, def: 75, spa: 100, spd: 100, spe: 70},
	...
	jumpluff: {
		...
		name: "Jumpluff",
		types: ["Grass", "Flying"],
		baseStats: {hp: 75, atk: 80, def: 80, spa: 55, spd: 95, spe: 110},
		abilities: {0: "Cotton Down", 1: "Leaf Guard", H: "Infiltrator"},
		heightm: 0.8,
		weightkg: 3,
		color: "Blue",
		prevo: "Skiploom",
		evoLevel: 27,
		eggGroups: ["Fairy", "Grass"],
		otherFormes: ["Jumpluff-Orre"],
		formeOrder: ["Jumpluff", "Jumpluff-Orre"],
	},
	aipom: {
		num: 190,
		name: "Aipom",
	...
	sunkern: {
		...
		abilities: {0: "Chlorophyll", 1: "Solar Power", H: "Sunray"},
		heightm: 0.3,
		weightkg: 1.8,
		color: "Yellow",
		evos: ["Sunflora"],
	...
	espeon: {
		...
		abilities: {0: "Synchronize", 1: "Sunray", H: "Magic Bounce"},
		heightm: 0.9,
		weightkg: 26.5,
		color: "Purple",
		prevo: "Eevee",
	...
	murkrowdelorea: {
		num: 198,
		name: "Murkrow-Delorea",
		baseSpecies: "Murkrow",
		forme: "Delorea",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 60, atk: 85, def: 42, spa: 85, spd: 42, spe: 91},
		abilities: {0: "Strong Winds", 1: "Daunt", H: "Hubris"},
		heightm: 0.5,
		weightkg: 2.1,
		color: "Black",
		evos: ["Honchkrow-Delorea"],
		eggGroups: ["Flying"],
		newmeta: "true",
	},
	slowking: {
	...
	girafarig: {
		...
		baseStats: {hp: 70, atk: 95, def: 65, spa: 85, spd: 65, spe: 90},
		abilities: {0: "Twinned", 1: "Magic Guard", H: "Sap Sipper"},
		heightm: 1.5,
		weightkg: 41.5,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	gligar: {
		...
		abilities: {0: "Hyper Cutter", 1: "Blood Sucker", H: "Immunity"},
		heightm: 1.1,
		weightkg: 64.8,
		color: "Purple",
		evos: ["Gliscor"],
	...
	gligarfiore: {
		...
		forme: "Fiore",
		types: ["Grass", "Flying"],
		baseStats: {hp: 65, atk: 105, def: 75, spa: 35, spd: 65, spe: 85},
		abilities: {0: "Sap Sipper", 1: "Blood Sucker", H: "Chlorophyll"},
		heightm: 1.1,
		weightkg: 64.8,
		color: "Orange",
		evos: ["Gliscor-Fiore"],
	...
	snubbull: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 70, atk: 85, def: 60, spa: 40, spd: 50, spe: 30},
	...
	granbull: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 95, atk: 125, def: 90, spa: 65, spd: 75, spe: 45},
	...
	qwilfish: {
		...
		name: "Qwilfish",
		types: ["Water", "Poison"],
		baseStats: {hp: 65, atk: 95, def: 90, spa: 55, spd: 65, spe: 95},
	...
	sneasel: {
		...
		evos: ["Weavile"],
		eggGroups: ["Field"],
		otherFormes: ["Sneasel-Hisui", "Sneasel-Almia"],
		formeOrder: ["Sneasel", "Sneasel-Hisui", "Sneasel-Almia"],
	},
	sneaselhisui: {
		num: 215,
		name: "Sneasel-Hisui",
	...
	teddiursa: {
		...
		abilities: {0: "Pickup", 1: "Quick Feet", H: "Solid Footing"},
		heightm: 0.6,
		weightkg: 8.8,
		color: "Brown",
		evos: ["Ursaring"],
	...
	ursaring: {
		...
		abilities: {0: "Guts", 1: "Quick Feet", H: "Solid Footing"},
		heightm: 1.8,
		weightkg: 125.8,
		color: "Brown",
		prevo: "Teddiursa",
	...
	magcargomega: {
		...
		forme: "Mega",
		types: ["Fire", "Rock"],
		baseStats: {hp: 60, atk: 50, def: 145, spa: 110, spd: 135, spe: 30},
		abilities: {0: "Magma Armor"},
		heightm: 0.8,
		weightkg: 57,
		color: "Red",
		eggGroups: ["Amorphous"],
		requiredItem: "Magcargite",
	},
	swinub: {
		num: 220,
		name: "Swinub",
	...
	octillery: {
		...
		abilities: {0: "Suction Cups", 1: "Sniper", H: "Artillery"},
		heightm: 0.9,
		weightkg: 28.5,
		color: "Red",
		prevo: "Remoraid",
	...
	delibird: {
		...
		name: "Delibird",
		types: ["Ice", "Flying"],
		baseStats: {hp: 65, atk: 55, def: 60, spa: 85, spd: 60, spe: 105},
		abilities: {0: "Vital Spirit", 1: "Hustle", H: "Refrigerate"},
		heightm: 0.9,
		weightkg: 16,
		color: "Red",
		eggGroups: ["Water 1", "Field"],
		otherFormes: ["Delibird-Galar"],
        formeOrder: ["Delibird", "Delibird-Galar"],
	},
	mantine: {
		num: 226,
		name: "Mantine",
		types: ["Water", "Flying"],
		baseStats: {hp: 90, atk: 40, def: 75, spa: 80, spd: 140, spe: 70},
	...
	hitmontop: {
		...
		abilities: {0: "Intimidate", 1: "Technician", H: "Kicker"},
		heightm: 1.4,
		weightkg: 48,
		color: "Brown",
		prevo: "Tyrogue",
	...
	smoochum: {
		...
		abilities: {0: "Oblivious", 1: "Lovely Lips", H: "Hydration"},
		heightm: 0.4,
		weightkg: 6,
		color: "Pink",
		evos: ["Jynx"],
	...
	raikou: {
		...
		abilities: {0: "Pressure", 1: "Lightning Rod", H: "Inner Focus"},
		heightm: 1.9,
		weightkg: 178,
		color: "Yellow",
		tags: ["Sub-Legendary"],
	...
	entei: {
		...
		abilities: {0: "Pressure", 1: "Conflagrant", H: "Inner Focus"},
		heightm: 2.1,
		weightkg: 198,
		color: "Brown",
		tags: ["Sub-Legendary"],
	...
	suicune: {
		...
		abilities: {0: "Pressure", 1: "Strong Winds", H: "Inner Focus"},
		heightm: 2,
		weightkg: 187,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	treecko: {
		...
		abilities: {0: "Overgrow", 1: "Hubris", H: "Unburden"},
		heightm: 0.5,
		weightkg: 5,
		color: "Green",
		evos: ["Grovyle"],
	...
	torchic: {
		...
		evos: ["Combusken"],
		eggGroups: ["Field"],
		otherFormes: ["Torchic-Hyperspace"],
		formeOrder: ["Torchic", "Torchic-Hyperspace"],
	},
	combusken: {
		num: 256,
		name: "Combusken",
		...
		evos: ["Blaziken"],
		eggGroups: ["Field"],
		otherFormes: ["Combusken-Hyperspace"],
		formeOrder: ["Combusken", "Combusken-Hyperspace"],
	},
	blaziken: {
		num: 257,
		name: "Blaziken",
		...
		abilities: {0: "Blaze", 1: "Kicker", H: "Speed Boost"},
		heightm: 1.9,
		weightkg: 52,
		color: "Red",
		prevo: "Combusken",
		evoLevel: 36,
		eggGroups: ["Field"],
		otherFormes: ["Blaziken-Mega", "Blaziken-Hyperspace"],
		formeOrder: ["Blaziken", "Blaziken-Mega", "Blaziken-Hyperspace"],
	},
	blazikenmega: {
		num: 257,
		name: "Blaziken-Mega",
	...
	torchichyperspace: {
		num: 255,
		name: "Torchic-Hyperspace",
		baseSpecies: "Torchic",
		forme: "Hyperspace",
		types: ["Steel", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 45, atk: 90, def: 40, spa: 40, spd: 50, spe: 45},
		abilities: {0: "Ignition", H: "Speed Boost"},
		heightm: 0.4,
		weightkg: 2.5,
		color: "Gray",
		prevo: "Torchic-Hypersace",
		evoLevel: 16,
		evos: ["Combusken-Hyperspace"],
		eggGroups: ["Undiscovered"],
	},
	combuskenhyperspace: {
		num: 256,
		name: "Combusken-Hyperspace",
		baseSpecies: "Combusken",
		forme: "Hyperspace",
		types: ["Steel", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 100, def: 60, spa: 70, spd: 60, spe: 55},
		abilities: {0: "Ignition", H: "Speed Boost"},
		heightm: 0.9,
		weightkg: 19.5,
		color: "Gray",
		prevo: "Torchic-Hypersace",
		evoLevel: 16,
		evos: ["Blaziken-Hyperspace"],
		eggGroups: ["Undiscovered"],
		},
	blazikenhyperspace: {
		num: 257,
		name: "Blaziken-Hyperspace",
		baseSpecies: "Blaziken",
		forme: "Hyperspace",
		types: ["Steel", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 120, def: 70, spa: 100, spd: 70, spe: 90},
		abilities: {0: "Ignition", 1: "Adaptability", H: "Speed Boost"},
		heightm: 1.9,
		weightkg: 70,
		color: "Gray",
		prevo: "Combusken-Hyperspace",
		evoLevel: 36,
		eggGroups: ["Undiscovered"],
	},
	mudkip: {
		...
		abilities: {0: "Torrent", 1: "Mold Breaker", H: "Damp"},
		heightm: 0.4,
		weightkg: 7.6,
		color: "Blue",
		evos: ["Marshtomp"],
	...
	poochyena: {
		...
		name: "Poochyena",
		types: ["Dark"],
		baseStats: {hp: 35, atk: 65, def: 35, spa: 30, spd: 30, spe: 40},
	...
	mightyena: {
		...
		name: "Mightyena",
		types: ["Dark"],
		baseStats: {hp: 70, atk: 100, def: 80, spa: 60, spd: 60, spe: 101},
	...
	lotad: {
		...
		name: "Lotad",
		types: ["Water", "Grass"],
		baseStats: {hp: 70, atk: 40, def: 40, spa: 50, spd: 50, spe: 40},
	...
	lombre: {
		...
		name: "Lombre",
		types: ["Water", "Grass"],
		baseStats: {hp: 85, atk: 65, def: 65, spa: 70, spd: 80, spe: 60},
		abilities: {0: "Swift Swim", 1: "Rain Dish", H: "Own Tempo"},
		heightm: 1.2,
		weightkg: 32.5,
		color: "Green",
	...
	seedot: {
		...
		name: "Seedot",
		types: ["Grass"],
		baseStats: {hp: 40, atk: 50, def: 70, spa: 40, spd: 60, spe: 30},
	...
	nuzleaf: {
		...
		name: "Nuzleaf",
		types: ["Grass", "Dark"],
		baseStats: {hp: 70, atk: 90, def: 60, spa: 85, spd: 60, spe: 60},
		abilities: {0: "Chlorophyll", 1: "Early Bird", H: "Pickpocket"},
		heightm: 1,
		weightkg: 28,
		color: "Brown",
	...
	gardevoir: {
		...
		abilities: {0: "Perseverance", 1: "Trace", H: "Telepathy"},
		heightm: 1.6,
		weightkg: 48.4,
		color: "White",
		prevo: "Kirlia",
	...
	nincada: {
		...
		name: "Nincada",
		types: ["Bug", "Ground"],
		baseStats: {hp: 31, atk: 60, def: 90, spa: 30, spd: 30, spe: 50},
		abilities: {0: "Compound Eyes", H: "Run Away"},
		heightm: 0.5,
		weightkg: 5.5,
		color: "Gray",
		evos: ["Ninjask", "Ninjask-Galar", "Shedinja", "Shedinja-Galar"],
		eggGroups: ["Bug"],
	},
	ninjask: {
		num: 291,
		...
		evoLevel: 20,
		eggGroups: ["Bug"],
		otherFormes: ["Ninjask-Galar"],
        formeOrder: ["Ninjask", "Ninjask-Galar"],
	},
	ninjaskgalar: {
		num: 291,
		name: "Ninjask-Galar",
	...
	shedinja: {
		...
		evoLevel: 20,
		eggGroups: ["Mineral"],
		otherFormes: ["Shedinja-Galar"],
        formeOrder: ["Shedinja", "Shedinja-Galar"],
	},
	shedinjagalar: {
		num: 292,
		name: "Shedinja-Galar",
	...
	nosepass: {
		...
		name: "Nosepass",
		types: ["Rock"],
		baseStats: {hp: 30, atk: 55, def: 135, spa: 45, spd: 90, spe: 30},
		abilities: {0: "Sturdy", 1: "Magnet Pull", H: "Volt Absorb"},
		heightm: 1,
		weightkg: 97,
		color: "Gray",
		evos: ["Probopass"],
	...
	skitty: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 50, atk: 55, def: 45, spa: 45, spd: 35, spe: 55},
		abilities: {0: "Wonder Skin", 1: "Normalize", H: "Prankster"},
		heightm: 0.6,
		weightkg: 11,
		color: "Pink",
		evos: ["Delcatty"],
	...
	delcatty: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 70, atk: 75, def: 65, spa: 65, spd: 55, spe: 90},
		abilities: {0: "Wonder Skin", 1: "Normalize", H: "Prankster"},
		heightm: 1.1,
		weightkg: 32.6,
		color: "Purple",
	...
	intricat: {
		...
		types: ["Normal", "Cosmic"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 80, atk: 95, def: 80, spa: 95, spd: 70, spe: 115},
		abilities: {0: "Wonder Skin", 1: "Normalize", H: "Prankster"},
		heightm: 1.5,
		weightkg: 36.6,
		color: "Purple",
...
//        formeOrder: ["Aron", "Aron-Quantum"],
	...
	lairon: {
		...
		abilities: {0: "Sturdy", 1: "Rock Head", H: "Defiant"},
		heightm: 0.9,
		weightkg: 120,
		color: "Gray",
		prevo: "Aron",
...
//	aronquantum: {
	...
	//	forme: "Quantum",
	//	types: ["Cosmic"],
	//	baseStats: {hp: 60, atk: 60, def: 40, spa: 40, spd: 100, spe: 30},
	//	abilities: {0: "Levitate"},
	//	heightm: 0.4,
	//	weightkg: 60,
	//	color: "Gray",
...
//		forme: "Quantum",
//		types: ["Cosmic", "Steel"],
//		baseStats: {hp: 70, atk: 80, def: 80, spa: 50, spd: 110, spe: 40},
//		abilities: {0: "Levitate", 1: "Sturdy", H: "Adaptability"},
//		heightm: 0.9,
//		weightkg: 120,
//		color: "Gray",
//		prevo: "Aron-Quantum",
...
//	},
	meditite: {
		...
		abilities: {0: "Pure Power", 1: "Fortitude", H: "Telepathy"},
		heightm: 0.6,
		weightkg: 11.2,
		color: "Blue",
		evos: ["Medicham"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Meditite-Kalos"],
		formeOrder: ["Meditite", "Meditite-Kalos"],
	},
	medicham: {
		num: 308,
		name: "Medicham",
		...
		evoLevel: 37,
		eggGroups: ["Human-Like"],
		otherFormes: ["Medicham-Mega", "Medicham-Kalos"],
		formeOrder: ["Medicham", "Medicham-Mega", "Medicham-Kalos"],
	},
	...
	medititekalos: {
		...
		types: ["Psychic", "Fairy"],
		baseStats: {hp: 30, atk: 40, def: 55, spa: 40, spd: 55, spe: 60},
		abilities: {0: "Wise Power", H: "Telepathy"},
		heightm: 0.6,
		weightkg: 11.2,
		color: "Blue",
		evos: ["Medicham-Kalos"],
	...
	volbeat: {
		...
		types: ["Bug", "Light"],
		gender: "M",
		baseStats: {hp: 65, atk: 73, def: 85, spa: 67, spd: 85, spe: 85},
	...
	illumise: {
		...
		types: ["Bug", "Light"],
		gender: "F",
		baseStats: {hp: 65, atk: 67, def: 85, spa: 73, spd: 85, spe: 85},
	...
	swalot: {
		...
		name: "Swalot",
		types: ["Poison"],
		baseStats: {hp: 110, atk: 73, def: 93, spa: 88, spd: 93, spe: 55},
		abilities: {0: "Liquid Ooze", 1: "Sticky Hold", H: "Gluttony"},
		heightm: 1.7,
		weightkg: 80,
		color: "Purple",
	...
	wailord: {
		...
		name: "Wailord",
		types: ["Water"],
		baseStats: {hp: 170, atk: 95, def: 60, spa: 95, spd: 60, spe: 60},
		abilities: {0: "Water Veil", 1: "Oblivious", H: "Pressure"},
		heightm: 14.5,
		weightkg: 398,
		color: "Blue",
	...
	numel: {
		...
		name: "Numel",
		types: ["Fire", "Ground"],
		baseStats: {hp: 60, atk: 60, def: 50, spa: 65, spd: 55, spe: 35},
		abilities: {0: "Magma Armor", 1: "Simple", H: "Own Tempo"},
		heightm: 0.7,
		weightkg: 24,
		color: "Yellow",
		evos: ["Camerupt"],
	...
	camerupt: {
		...
		name: "Camerupt",
		types: ["Fire", "Ground"],
		baseStats: {hp: 90, atk: 70, def: 90, spa: 115, spd: 95, spe: 40},
	...
	cameruptmega: {
		...
		forme: "Mega",
		types: ["Fire", "Ground"],
		baseStats: {hp: 90, atk: 100, def: 120, spa: 145, spd: 125, spe: 20},
	...
	spoink: {
		...
		abilities: {0: "Thick Fat", 1: "Enthusiasm", H: "Gluttony"},
		heightm: 0.7,
		weightkg: 30.6,
		color: "Black",
		evos: ["Grumpig"],
	...
	grumpig: {
		...
		evoLevel: 32,
		eggGroups: ["Field"],
		otherFormes: ["Grumpig-Lokura"],
		formeOrder: ["Grumpig", "Grumpig-Lokura"],
	},
	spinda: {
		num: 327,
		name: "Spinda",
	...
	flygon: {
		...
		evoLevel: 45,
		eggGroups: ["Bug", "Dragon"],
		otherFormes: ["Flygon-Mega", "Flygon-Orre"],
		formeOrder: ["Flygon", "Flygon-Mega", "Flygon-Orre"],
	},
	flygonorre: {
		num: 330,
		name: "Flygon-Orre",
		...
		abilities: {0: "Analytic", 1: "Solar Power", H: "Soundproof"},
		heightm: 2,
		weightkg: 82,
		color: "Green",
		prevo: "Vibrava",
	...
	cacturne: {
		...
		name: "Cacturne",
		types: ["Grass", "Dark"],
		baseStats: {hp: 80, atk: 115, def: 60, spa: 115, spd: 60, spe: 55},
		abilities: {0: "Sand Rush", H: "Water Absorb"},
		heightm: 1.3,
		weightkg: 77.4,
		color: "Green",
	...
	swablu: {
		...
		name: "Swablu",
		types: ["Normal", "Flying"],
		baseStats: {hp: 45, atk: 40, def: 55, spa: 45, spd: 75, spe: 50},
		...
		otherFormes: ["Swablu-Sinnoh"],
		formeOrder: ["Swablu", "Swablu-Sinnoh"],
	},
		swablusinnoh: {
		num: 333,
		name: "Swablu-Sinnoh",
	...
	altaria: {
		...
		formeOrder: ["Altaria", "Altaria-Mega, Altaria-Sinnoh"],
	},
	altariamega: {
		num: 334,
		name: "Altaria-Mega",
	...
	zangoose: {
		...
		name: "Zangoose",
		types: ["Normal"],
		baseStats: {hp: 100, atk: 115, def: 65, spa: 60, spd: 65, spe: 90},
		abilities: {0: "Immunity", 1: "Last Stand", H: "Toxic Boost"},
		heightm: 1.3,
		weightkg: 40.3,
		color: "White",
		eggGroups: ["Field"],
	...
	seviper: {
		...
		name: "Seviper",
		types: ["Poison"],
		baseStats: {hp: 75, atk: 100, def: 65, spa: 100, spd: 65, spe: 90},
	...
	lunatone: {
		...
		abilities: {0: "Levitate", H: "Orbital"},
		heightm: 1,
		weightkg: 168,
		color: "Yellow",
		eggGroups: ["Mineral"],
	...
	barboach: {
		...
		abilities: {0: "Oblivious", 1: "Fish Memory", H: "Hydration"},
		heightm: 0.4,
		weightkg: 1.9,
		color: "Gray",
		evos: ["Whiscash"],
	...
	whiscash: {
		...
		evoLevel: 30,
		eggGroups: ["Water 2"],
		otherFormes: ["Whiscash-Oblivia"],
        formeOrder: ["Whiscash", "Whiscash-Oblivia"],
	},
	whiscashoblivia: {
		num: 340,
		name: "Whiscash-Oblivia",
		baseSpecies: "Whiscash",
        forme: "Oblivia",
		types: ["Ghost", "Fire"],
		baseStats: {hp: 60, atk: 76, def: 73, spa: 110, spd: 71, spe: 78},
		abilities: {0: "Flame Body", 1: "Fish Memory", H: "Magic Guard"},
		heightm: 0.9,
		weightkg: 23.6,
		color: "Purple",
		evoLevel: 30,
	...
	lileep: {
		...
		abilities: {0: "Suction Cups", 1: "Tight Grip", H: "Storm Drain"},
		heightm: 1,
		weightkg: 23.8,
		color: "Purple",
		evos: ["Cradily"],
	...
	anorith: {
		...
		abilities: {0: "Battle Armor", 1: "Blade Master", H: "Swift Swim"},
		heightm: 0.7,
		weightkg: 12.5,
		color: "Gray",
		evos: ["Armaldo"],
	...
	shuppet: {
		...
		abilities: {0: "Insomnia", 1: "Remorse", H: "Cursed Body"},
		heightm: 0.6,
		weightkg: 2.3,
		color: "Black",
		evos: ["Banette"],
	...
	banette: {
		...
		abilities: {0: "Undead", 1: "Remorse", H: "Cursed Body"},
		heightm: 1.1,
		weightkg: 12.5,
		color: "Black",
		prevo: "Shuppet",
	...
	tropius: {
		...
		name: "Tropius",
		types: ["Grass", "Flying"],
		baseStats: {hp: 119, atk: 88, def: 83, spa: 82, spd: 87, spe: 51},
	...
	tropiusorre: {
		...
		forme: "Orre",
		types: ["Cosmic", "Dragon"],
		baseStats: {hp: 87, atk: 99, def: 72, spa: 99, spd: 72, spe: 81},
	...
	absol: {
		...
		abilities: {0: "Blade Master", 1: "Super Luck", H: "Justified"},
		heightm: 1.2,
		weightkg: 47,
		color: "White",
		eggGroups: ["Field"],
	...
	absolmega: {
		...
		forme: "Mega",
		types: ["Dark"],
		baseStats: {hp: 65, atk: 150, def: 60, spa: 125, spd: 60, spe: 125},
		abilities: {0: "Magic Bounce"},
		heightm: 1.2,
		weightkg: 49,
		color: "White",
	...
	gorebyss: {
		...
		name: "Gorebyss",
		types: ["Water"],
		baseStats: {hp: 75, atk: 94, def: 105, spa: 114, spd: 75, spe: 52},
	...
	relicanth: {
		...
		types: ["Water", "Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 110, atk: 105, def: 130, spa: 45, spd: 80, spe: 55},
	...
	luvdisc: {
		...
		abilities: {0: "Swift Swim", 1: "Lovely Lips", H: "Hydration"},
		heightm: 0.6,
		weightkg: 8.7,
		color: "Pink",
		eggGroups: ["Water 2"],
	...
	registeel: {
		...
		abilities: {0: "Clear Body", 1: "Heatproof", H: "Light Metal"},
		heightm: 1.9,
		weightkg: 205,
		color: "Gray",
		tags: ["Sub-Legendary"],
	...
	turtwig: {
		...
		abilities: {0: "Overgrow", 1: "Harvest", H: "Shell Armor"},
		heightm: 0.4,
		weightkg: 10.2,
		color: "Green",
		evos: ["Grotle"],
	...
	chimchar: {
		...
		abilities: {0: "Blaze", 1: "Fortitude", H: "Iron Fist"},
		heightm: 0.5,
		weightkg: 6.2,
		color: "Brown",
		evos: ["Monferno"],
	...
	piplup: {
		...
		abilities: {0: "Torrent", 1: "Battle Armor", H: "Competitive"},
		heightm: 0.4,
		weightkg: 5.2,
		color: "Blue",
		evos: ["Prinplup"],
	...
	shinx: {
		...
		name: "Shinx",
		types: ["Electric"],
		baseStats: {hp: 45, atk: 65, def: 34, spa: 40, spd: 34, spe: 70},
	...
	luxio: {
		...
		name: "Luxio",
		types: ["Electric", "Dark"],
		baseStats: {hp: 60, atk: 85, def: 49, spa: 60, spd: 49, spe: 85},
		abilities: {0: "Rivalry", 1: "Intimidate", H: "Guts"},
		heightm: 0.9,
		weightkg: 30.5,
		color: "Blue",
	...
	luxray: {
		...
		name: "Luxray",
		types: ["Electric", "Dark"],
		baseStats: {hp: 80, atk: 120, def: 79, spa: 95, spd: 79, spe: 85},
		abilities: {0: "Rivalry", 1: "Intimidate", H: "Guts"},
		heightm: 1.4,
		weightkg: 42,
		color: "Blue",
	...
	roserade: {
		...
		name: "Roserade",
		types: ["Grass", "Poison"],
		baseStats: {hp: 60, atk: 70, def: 65, spa: 125, spd: 105, spe: 100},
		abilities: {0: "Natural Cure", 1: "Poison Point", H: "Analytic"},
		heightm: 0.9,
		weightkg: 14.5,
		color: "Green",
		prevo: "Roselia",
	...
	rampardos: {
		...
		types: ["Rock"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 119, atk: 165, def: 60, spa: 65, spd: 50, spe: 58},
		abilities: {0: "Mold Breaker", 1: "Reckless", H: "Sheer Force"},
		heightm: 1.6,
		weightkg: 102.5,
		color: "Blue",
	...
	rampardosalmian: {
		num: 409,
		name: "Rampardos-Almian",
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 97, atk: 155, def: 50, spa: 70, spd: 60, spe: 85},
		abilities: {0: "Own Tempo", H: "Conflagrant"},
		heightm: 1.6,
		weightkg: 102.5,
		color: "Red",
		evoLevel: 30,
	...
	shieldon: {
		...
		abilities: {0: "Sturdy", 1: "Battle Armor", H: "Soundproof"},
		heightm: 0.5,
		weightkg: 57,
		color: "Gray",
		evos: ["Bastiodon"],
	...
	bastiodon: {
		...
		types: ["Rock", "Steel"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 91, def: 168, spa: 30, spd: 138, spe: 30},
		abilities: {0: "Sturdy", 1: "Battle Armor", H: "Soundproof"},
		heightm: 1.3,
		weightkg: 149.5,
		color: "Gray",
	...
	wormadam: {
		...
		types: ["Bug", "Grass"],
		gender: "F",
		baseStats: {hp: 76, atk: 59, def: 85, spa: 80, spd: 123, spe: 40},
	...
	wormadamsandy: {
		...
		types: ["Bug", "Ground"],
		gender: "F",
		baseStats: {hp: 76, atk: 80, def: 123, spa: 59, spd: 85, spe: 40},
		abilities: {0: "Anticipation", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Brown",
	...
	wormadamtrash: {
		...
		types: ["Bug", "Steel"],
		gender: "F",
		baseStats: {hp: 76, atk: 71, def: 102, spa: 72, spd: 102, spe: 40},
		abilities: {0: "Anticipation", H: "Overcoat"},
		heightm: 0.5,
		weightkg: 6.5,
		color: "Red",
	...
	mothim: {
		...
		types: ["Bug", "Flying"],
		gender: "M",
		baseStats: {hp: 70, atk: 94, def: 65, spa: 94, spd: 65, spe: 75},
	...
	cherrim: {
		...
		baseForme: "Overcast",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 95, def: 70, spa: 87, spd: 78, spe: 100},
	...
	cherrimsunshine: {
		...
		forme: "Sunshine",
		types: ["Grass", "Light"],
		baseStats: {hp: 60, atk: 100, def: 70, spa: 92, spd: 78, spe: 100},
		abilities: {0: "Flower Gift"},
		heightm: 0.5,
		weightkg: 9.3,
		color: "Pink",
	...
	drifblim: {
		...
		name: "Drifblim",
		types: ["Ghost", "Flying"],
		baseStats: {hp: 150, atk: 80, def: 54, spa: 90, spd: 64, spe: 80},
		abilities: {0: "Aftermath", 1: "Unburden", H: "Flare Boost"},
		heightm: 1.2,
		weightkg: 15,
		color: "Purple",
	...
	lopunny: {
		...
		abilities: {0: "Limber", 1: "Klutz", H: "Kicker"},
		heightm: 1.3,
		weightkg: 33.3,
		color: "Brown",
		prevo: "Buneary",
	...
	honchkrow: {
		...
		abilities: {0: "Daunt", 1: "Super Luck", H: "Moxie"},
		heightm: 0.9,
		weightkg: 27.3,
		color: "Black",
		prevo: "Murkrow",
	...
	honchkrowdelorea: {
		num: 430,
		name: "Honchkrow-Delorea",
		baseSpecies: "Honchkrow",
		forme: "Delorea",
		types: ["Dragon", "Flying"],
		baseStats: {hp: 100, atk:105, def: 52, spa: 125, spd: 52, spe: 71},
		abilities: {0: "Strong Winds", 1: "Daunt", H: "Hubris"},
		heightm: 0.9,
		weightkg: 27.3,
		color: "Black",
		prevo: "Murkrow-Delorea",
		evoType: "useItem",
		evoItem: "Dusk Stone",
		eggGroups: ["Flying"],
		newmeta: "true",
	...
	glameow: {
		...
		abilities: {0: "Limber", 1: "Tough Claws", H: "Keen Eye"},
		heightm: 0.5,
		weightkg: 3.9,
		color: "Gray",
		evos: ["Purugly"],
	...
	purugly: {
		...
		types: ["Normal"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 81, atk: 95, def: 64, spa: 64, spd: 59, spe: 112},
		abilities: {0: "Thick Fat", 1: "Tough Claws", H: "Defiant"},
		heightm: 1,
		weightkg: 43.8,
		color: "Gray",
		prevo: "Glameow",
	...
	stunky: {
		...
		abilities: {0: "Stench", 1: "Aftermath", H: "Poison Cloak"},
		heightm: 0.4,
		weightkg: 19.2,
		color: "Purple",
		evos: ["Skuntank"],
	...
	chatotorren: {
		...
		name: "Chatot-Orren",
		types: ["Electric", "Dark"],
		baseStats: {hp: 76, atk: 42, def: 48, spa: 90, spd: 65, spe: 90},
		abilities: {0: "Competitive", H: "Galvanize"},
		heightm: 3.4,
		weightkg: 31,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	spiritomb: {
		...
		name: "Spiritomb",
		types: ["Ghost", "Dark"],
		baseStats: {hp: 60, atk: 100, def: 108, spa: 100, spd: 108, spe: 35},
		abilities: {0: "Remorse", 1: "Pressure", H: "Infiltrator"},
		heightm: 1,
		weightkg: 108,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	garchompalola: {
		...
		name: "Garchomp-Alola",
		types: ["Water", "Dragon"],
		baseStats: {hp: 108, atk: 120, def: 95, spa: 80, spd: 95, spe: 102},
	...
	riolu: {
		...
		types: ["Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 40, atk: 75, def: 50, spa: 35, spd: 50, spe: 70},
	...
	lucario: {
		...
		abilities: {0: "Steadfast", 1: "Perseverance", H: "Justified"},
		heightm: 1.2,
		weightkg: 54,
		color: "Blue",
		prevo: "Riolu",
	...
	hippopotas: {
		...
		evos: ["Hippowdon"],
		eggGroups: ["Field"],
		otherFormes: ["Hippopotas-Orre"],
        formeOrder: ["Hippopotas", "Hippopotas-Orre"],
	},
	hippowdon: {
		num: 450,
		name: "Hippowdon",
		...
		evoLevel: 34,
		eggGroups: ["Field"],
		otherFormes: ["Hippowdon-Orre"],
        formeOrder: ["Hippowdon", "Hippowdon-Orre"],
	},

	hippopotasorre: {
		num: 449,
		name: "Hippopotas-Orre",
		baseSpecies: "Hippopotas",
		forme: "Orre",
		types: ["Poison"],
		baseStats: {hp: 68, atk: 72, def: 78, spa: 38, spd: 42, spe: 32},
		abilities: {0: "Poison Touch", 1: "Toxic Intake", H: "Toxic Wasteland"},
		heightm: 0.8,
		weightkg: 49.5,
		color: "Purple",
		evos: ["Hippowdon-Orre"],
	...
	skorupi: {
		...
		abilities: {0: "Battle Armor", 1: "Sniper", H: "Toxic Rush"},
		heightm: 0.8,
		weightkg: 12,
		color: "Purple",
		evos: ["Drapion"],
	...
	croagunk: {
		...
		abilities: {0: "Toxic Rush", 1: "Dry Skin", H: "Poison Touch"},
		heightm: 0.7,
		weightkg: 23,
		color: "Blue",
		evos: ["Toxicroak"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Croagunk-Lokura"],
		formeOrder: ["Croagunk", "Croagunk-Lokura"],
	},
	toxicroak: {
		num: 454,
		name: "Toxicroak",
		types: ["Poison", "Fighting"],
		baseStats: {hp: 83, atk: 112, def: 70, spa: 88, spd: 70, spe: 102},
		...
		evoLevel: 37,
		eggGroups: ["Human-Like"],
		otherFormes: ["Toxicroak-Lokura"],
		formeOrder: ["Toxicroak", "Toxicroak-Lokura"],
	},
	carnivine: {
		num: 455,
		name: "Carnivine",
		types: ["Grass"],
		baseStats: {hp: 84, atk: 120, def: 77, spa: 90, spd: 77, spe: 46},
		abilities: {0: "Levitate", 1: "Water Absorb", H: "Tangling Hair"},
		heightm: 1.4,
		weightkg: 27,
		color: "Green",
		eggGroups: ["Grass"],
	...
	lumineon: {
		...
		name: "Lumineon",
		types: ["Water", "Light"],
		baseStats: {hp: 90, atk: 70, def: 85, spa: 90, spd: 90, spe: 95},
	...
	abomasnow: {
		...
		name: "Abomasnow",
		types: ["Grass", "Ice"],
		baseStats: {hp: 90, atk: 99, def: 85, spa: 99, spd: 91, spe: 60},
		abilities: {0: "Snow Warning", 1: "Snow Packing", H: "Soundproof"},
		heightm: 2.2,
		weightkg: 135.5,
		color: "White",
		prevo: "Snover",
	...
	abomasnowmega: {
		...
		forme: "Mega",
		types: ["Grass", "Ice"],
		baseStats: {hp: 90, atk: 135, def: 117, spa: 135, spd: 117, spe: 30},
	...
	weavile: {
		...
		abilities: {0: "Pressure", 1: "Keen Eye", H: "Pickpocket"},
		heightm: 1.1,
		weightkg: 34,
		color: "Black",
		prevo: "Sneasel",
	...
	rhyperior: {
		...
		name: "Rhyperior",
		types: ["Ground", "Rock"],
		baseStats: {hp: 115, atk: 140, def: 130, spa: 55, spd: 75, spe: 40},
	...
	electivire: {
		...
		abilities: {0: "Motor Drive", 1: "Dynamo", H: "Iron Fist"},
		heightm: 1.8,
		weightkg: 138.6,
		color: "Yellow",
		prevo: "Electabuzz",
	...
	magmortar: {
		...
		abilities: {0: "Flame Body", 1: "Conflagrant", H: "Artillery"},
		heightm: 1.6,
		weightkg: 68,
		color: "Red",
		prevo: "Magmar",
	...
	leafeon: {
		...
		abilities: {0: "Leaf Guard", 1: "Blade Master", H: "Chlorophyll"},
		heightm: 1,
		weightkg: 25.5,
		color: "Green",
		prevo: "Eevee",
	...
	gliscor: {
		...
		abilities: {0: "Hyper Cutter", 1: "Blood Sucker", H: "Poison Heal"},
		heightm: 2,
		weightkg: 42.5,
		color: "Purple",
		prevo: "Gligar",
	...
	gliscorfiore: {
		...
		forme: "Fiore",
		types: ["Grass", "Flying"],
		baseStats: {hp: 75, atk: 125, def: 95, spa: 45, spd: 75, spe: 95},
		abilities: {0: "Sap Sipper", 1: "Blood Sucker", H: "Chlorophyll"},
		heightm: 2,
		weightkg: 42.5,
		color: "Orange",
	...
	mamoswine: {
		...
		abilities: {0: "Oblivious", 1: "Snow Packing", H: "Thick Fat"},
		heightm: 2.5,
		weightkg: 291,
		color: "Brown",
		prevo: "Piloswine",
	...
	gallade: {
		...
		abilities: {0: "Blade Master", 1: "Perseverance", H: "Justified"},
		heightm: 1.6,
		weightkg: 52,
		color: "White",
		prevo: "Kirlia",
	...
	probopass: {
		...
		name: "Probopass",
		types: ["Rock", "Steel"],
		baseStats: {hp: 60, atk: 55, def: 145, spa: 105, spd: 150, spe: 30},
		abilities: {0: "Sturdy", 1: "Magnet Pull", H: "Volt Absorb"},
		heightm: 1.4,
		weightkg: 340,
		color: "Gray",
	...
	dusknoir: {
		...
		abilities: {0: "Pressure", 1: "Daunt", H: "Frisk"},
		heightm: 2.2,
		weightkg: 106.6,
		color: "Black",
		prevo: "Dusclops",
	...
	froslass: {
		...
		abilities: {0: "Snow Cloak", 1: "Remorse", H: "Cursed Body"},
		heightm: 1.3,
		weightkg: 26.6,
		color: "White",
		prevo: "Snorunt",
	...
	froslassmega: {
		...
		types: ["Ice", "Ghost"],
		gender: "F",
		baseStats: {hp: 70, atk: 105, def: 80, spa: 120, spd: 80, spe: 125},
		abilities: {0: "No Guard"},
		heightm: 1.3,
		weightkg: 26.6,
		color: "White",
		eggGroups: ["Human-Like"],
		requiredItem: "Froslasite",
	},
	rotom: {
		num: 479,
		name: "Rotom",
	...
	dialga: {
		...
		abilities: {0: "Pressure", H: "Time Reverse"},
		heightm: 5.4,
		weightkg: 683,
		tags: ["Restricted Legendary"],
		color: "White",
	...
	palkia: {
		...
		abilities: {0: "Pressure", H: "Orbital"},
		heightm: 4.2,
		weightkg: 336,
		color: "Purple",
		tags: ["Restricted Legendary"],
	...
	arceuslight: {
		...
		color: "Gray",
		eggGroups: ["Undiscovered"],
		requiredItems: ["Radiant Plate", "Lightium Z"],
		changesFrom: "Arceus",
	},
	arceuscosmic: {
		num: 493,
		...
		color: "Gray",
		eggGroups: ["Undiscovered"],
		requiredItems: ["Spatial Plate", "Cosmium Z"],
		changesFrom: "Arceus",
	},
	victini: {
		num: 494,
	...
	tepig: {
		...
		abilities: {0: "Blaze", 1: "Expert", H: "Thick Fat"},
		heightm: 0.5,
		weightkg: 9.9,
		color: "Red",
		evos: ["Pignite"],
	...
	emboar: {
		...
		abilities: {0: "Blaze", 1: "Expert", H: "Reckless"},
		heightm: 1.6,
		weightkg: 150,
		color: "Red",
		prevo: "Pignite",
	...
	oshawott: {
		...
		abilities: {0: "Torrent", 1: "Blade Master", H: "Shell Armor"},
		heightm: 0.5,
		weightkg: 5.9,
		color: "Blue",
		evos: ["Dewott"],
	...
	watchog: {
		...
		name: "Watchog",
		types: ["Normal", "Light"],
		baseStats: {hp: 60, atk: 104, def: 69, spa: 60, spd: 73, spe: 84},
	...
	purrloin: {
		...
		abilities: {0: "Limber", 1: "Hubris", H: "Prankster"},
		heightm: 0.4,
		weightkg: 10.1,
		color: "Purple",
		evos: ["Liepard"],
	...
	liepard: {
		...
		name: "Liepard",
		types: ["Dark"],
		baseStats: {hp: 64, atk: 98, def: 60, spa: 98, spd: 60, spe: 106},
		abilities: {0: "Limber", 1: "Hubris", H: "Prankster"},
		heightm: 1.1,
		weightkg: 37.5,
		color: "Purple",
	...
	simisage: {
		...
		abilities: {0: "Gluttony", 1: "Herbivore", H: "Overgrow"},
		heightm: 1.1,
		weightkg: 30.5,
		color: "Green",
		prevo: "Pansage",
	...
	simisear: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 98, def: 63, spa: 98, spd: 63, spe: 101},
		abilities: {0: "Gluttony", 1: "Ignition", H: "Blaze"},
		heightm: 1,
		weightkg: 28,
		color: "Red",
		prevo: "Pansear",
	...
	simipour: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 75, atk: 98, def: 63, spa: 98, spd: 63, spe: 101},
		abilities: {0: "Gluttony", 1: "Water Absorb", H: "Torrent"},
		heightm: 1,
		weightkg: 29,
		color: "Blue",
		prevo: "Panpour",
	...
	zebstrika: {
		...
		name: "Zebstrika",
		types: ["Electric"],
		baseStats: {hp: 85, atk: 110, def: 63, spa: 90, spd: 63, spe: 116},
	...
	gigalith: {
		...
		name: "Gigalith",
		types: ["Rock"],
		baseStats: {hp: 85, atk: 135, def: 130, spa: 60, spd: 90, spe: 15},
	...
	throh: {
		...
		types: ["Fighting"],
		gender: "M",
		baseStats: {hp: 120, atk: 110, def: 90, spa: 30, spd: 90, spe: 45},
	...
	sawk: {
		...
		abilities: {0: "Sturdy", 1: "Expert", H: "Mold Breaker"},
		heightm: 1.4,
		weightkg: 51,
		color: "Blue",
		eggGroups: ["Human-Like"],
	...
	leavanny: {
		...
		name: "Leavanny",
		types: ["Bug", "Grass"],
		baseStats: {hp: 75, atk: 123, def: 90, spa: 60, spd: 90, spe: 102},
		abilities: {0: "Swarm", 1: "Chlorophyll", H: "Blade Master"},
		heightm: 1.2,
		weightkg: 20.5,
		color: "Yellow",
		prevo: "Swadloon",
...
//	scolipedealtezza: {
//		num: 545,
//		name: "Scolipede-Altezza",
//		baseSpecies: "Scolipede",
//		forme: "Altezza",
//		types: ["Bug", "Dragon"],
//		baseStats: {hp: 70, atk: 105, def: 104, spa: 55, spd: 69, spe: 102},
//		abilities: {0: "Infiltrator", 1: "Solid Footing", H: "Moxie"},
//		heightm: 2.5,
//		weightkg: 200,
//		color: "Purple",
//		prevo: "Whirlipede",
...
//	},
	...
	sandile: {
		...
		abilities: {0: "Intimidate", 1: "Moxie", H: "Sunbathe"},
		heightm: 0.7,
		weightkg: 15.2,
		color: "Brown",
		evos: ["Krokorok"],
	...
	darumaka: {
		...
		abilities: {0: "Hustle", 1: "Conflagrant", H: "Inner Focus"},
		heightm: 0.6,
		weightkg: 37.5,
		color: "Red",
		evos: ["Darmanitan"],
	...
	darumakagalar: {
		...
		types: ["Ice"],
		baseStats: {hp: 70, atk: 90, def: 45, spa: 15, spd: 45, spe: 50},
		abilities: {0: "Hustle", 1: "Snow Packing", H: "Inner Focus"},
		heightm: 0.7,
		weightkg: 40,
		color: "White",
	...
	darmanitan: {
		...
		abilities: {0: "Sheer Force", 1: "Conflagrant", H: "Zen Mode"},
		heightm: 1.3,
		weightkg: 92.9,
		color: "Red",
		prevo: "Darumaka",
	...
	darmanitangalar: {
		...
		types: ["Ice"],
		baseStats: {hp: 105, atk: 140, def: 55, spa: 30, spd: 55, spe: 95},
		abilities: {0: "Gorilla Tactics", 1: "Snow Packing", H: "Zen Mode"},
		heightm: 1.7,
		weightkg: 120,
		color: "White",
	...
	maractus: {
		...
		name: "Maractus",
		types: ["Grass"],
		baseStats: {hp: 85, atk: 86, def: 77, spa: 111, spd: 77, spe: 60},
	...
	dwebble: {
		...
		otherFormes: ["Dwebble-Intea"],
		formeOrder: ["Dwebble", "Dwebble-Intea"],
	},
	crustle: {
		num: 558,
		name: "Crustle",
	...
	trubbish: {
		...
		abilities: {0: "Toxic Wasteland", 1: "Sticky Hold", H: "Aftermath"},
		heightm: 0.6,
		weightkg: 31,
		color: "Green",
		evos: ["Garbodor"],
	...
	garbodor: {
		...
		abilities: {0: "Toxic Wasteland", 1: "Weak Armor", H: "Aftermath"},
		heightm: 1.9,
		weightkg: 107.3,
		color: "Green",
		prevo: "Trubbish",
	...
	garbodormega: {
		...
		types: ["Poison", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 105, def: 72, spa: 135, spd: 72, spe: 110},
		abilities: {0: "Toxic Rush"},
		heightm: 2.4,
		weightkg: 155.5,
		color: "Green",
		eggGroups: ["Monster", "Grass"],
	...
	zoroark: {
		...
		types: ["Dark"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 120, def: 60, spa: 120, spd: 60, spe: 105},
		abilities: {0: "Illusion"},
		heightm: 1.6,
		weightkg: 81.1,
		color: "Gray",
	...
	gothitellemega: {
		...
		forme: "Mega",
		types: ["Psychic", "Cosmic"],
		baseStats: {hp: 70, atk: 70, def: 115, spa: 125, spd: 145, spe: 65},
		abilities: {0: "Visionary"},
		heightm: 1.5,
		weightkg: 46,
		color: "Purple",
		eggGroups: ["Human-Like"],
	...
	sawsbuck: {
		...
		baseForme: "Spring",
		types: ["Normal", "Grass"],
		baseStats: {hp: 80, atk: 105, def: 70, spa: 60, spd: 70, spe: 105},
		abilities: {0: "Chlorophyll", 1: "Sap Sipper", H: "Serene Grace"},
		heightm: 1.9,
		weightkg: 92.5,
		color: "Brown",
	...
	jellicent: {
		...
		name: "Jellicent",
		types: ["Water", "Ghost"],
		baseStats: {hp: 105, atk: 60, def: 80, spa: 90, spd: 110, spe: 60},
		abilities: {0: "Water Absorb", 1: "Cursed Body", H: "Damp"},
		heightm: 2.2,
		weightkg: 135,
		color: "White",
	...
	joltik: {
		...
		evos: ["Galvantula"],
		eggGroups: ["Bug"],
		otherFormes: ["Joltik-Sinnoh"],
		formeOrder: ["Joltik", "Joltik-Sinnoh"],
	},
	joltiksinnoh: {
		num: 595,
		name: "Joltik-Sinnoh",
		...
		forme: "Sinnoh",
		types: ["Bug", "Steel"],
		baseStats: {hp: 50, atk: 47, def: 60, spa: 57, spd: 50, spe: 55},
		abilities: {0: "Compound Eyes", 1: "Anticipation", H: "Stamina"},
		heightm: 0.1,
		weightkg: 0.6,
		color: "Gray",
		evos: ["Galvantula-Sinnoh"],
		eggGroups: ["Bug"],
		newmeta: "true",
	},
	galvantula: {
	...
	ferroseed: {
		...
		otherFormes: ["Ferroseed-Kliro"],
		formeOrder: ["Ferroseed", "Ferroseed-Kliro"],
	},
	ferroseedkliro: {
		num: 597,
	...
	ferrothorn: {
		...
		evoLevel: 40,
		eggGroups: ["Grass", "Mineral"],
		otherFormes: ["Ferrothorn-Kliro"],
		formeOrder: ["Ferrothorn", "Ferrothorn-Kliro"],
	},
	ferrothornkliro: {
		num: 598,
	...
	klink: {
		...
		abilities: {0: "Twinned", 1: "Minus", H: "Clear Body"},
		heightm: 0.3,
		weightkg: 21,
		color: "Gray",
		evos: ["Klang"],
	...
	klinklympeia: {
		...
		types: ["Steel", "Cosmic"],
		gender: "N",
		baseStats: {hp: 40, atk: 45, def: 60, spa: 55, spd: 70, spe: 30},
		abilities: {0: "Levitate"},
		heightm: 0.3,
		weightkg: 21,
		color: "Gray",
	...
	klanglympeia: {
		...
		types: ["Steel", "Cosmic"],
		gender: "N",
		baseStats: {hp: 60, atk: 70, def: 85, spa: 80, spd: 95, spe: 50},
		abilities: {0: "Levitate"},
		heightm: 0.6,
		weightkg: 51,
		color: "Gray",
	...
	beheeyem: {
		...
		name: "Beheeyem",
		types: ["Psychic", "Cosmic"],
		baseStats: {hp: 85, atk: 80, def: 80, spa: 125, spd: 95, spe: 40},
		abilities: {0: "Telepathy", 1: "Synchronize", H: "Analytic"},
		heightm: 1,
		weightkg: 34.5,
		color: "Brown",
	...
	chandelure: {
		...
		evoItem: "Dusk Stone",
		eggGroups: ["Amorphous"],
		otherFormes: ["Chandelure-Kliro"],
		formeOrder: ["Chandelure", "Chandelure-Kliro"],
	},
	axew: {
		num: 610,
		name: "Axew",
	...
	beartic: {
		...
		name: "Beartic",
		types: ["Ice"],
		baseStats: {hp: 95, atk: 130, def: 83, spa: 70, spd: 83, spe: 70},
		abilities: {0: "Snow Packing", 1: "Slush Rush", H: "Swift Swim"},
		heightm: 2.6,
		weightkg: 260,
		color: "White",
		prevo: "Cubchoo",
	...
	stunfisk: {
		...
		abilities: {0: "Static", 1: "Fish Memory", H: "Sand Veil"},
		heightm: 0.7,
		weightkg: 11,
		color: "Brown",
		eggGroups: ["Water 1", "Amorphous"],
	...
	stunfiskgalar: {
		...
		abilities: {0: "Mimicry", 1: "Fish Memory"},
		heightm: 0.7,
		weightkg: 20.5,
		color: "Green",
		eggGroups: ["Water 1", "Amorphous"],
	...
	mienfoo: {
		...
		abilities: {0: "Fortitude", 1: "Regenerator", H: "Reckless"},
		heightm: 0.9,
		weightkg: 20,
		color: "Yellow",
		evos: ["Mienshao"],
		eggGroups: ["Field", "Human-Like"],
		otherFormes: ["Mienfoo-Galar"],
        formeOrder: ["Mienfoo", "Mienfoo-Galar"],
	},
	mienfoogalar: {
		num: 619,
		name: "Mienfoo-Galar",
		...
		types: ["Fairy", "Ghost"],
		baseStats: {hp: 45, atk: 85, def: 50, spa: 55, spd: 50, spe: 65},
		abilities: {0: "Regenerator", 1: "Serene Grace", H: "Last Stand"},
		heightm: 0.9,
		weightkg: 20,
		color: "Pink",
		evos: ["Mienshao-Galar"],
	...
	mienshao: {
		...
		evoLevel: 50,
		eggGroups: ["Field", "Human-Like"],
		otherFormes: ["Mienshao-Galar"],
        formeOrder: ["Mienshao", "Mienshao-Galar"],
	},
	mienshaogalar: {
		num: 620,
		name: "Mienshao-Galar",
	...
	druddigon: {
		...
		name: "Druddigon",
		types: ["Dragon"],
		baseStats: {hp: 77, atk: 120, def: 100, spa: 60, spd: 100, spe: 48},
	...
	golurk: {
		...
		types: ["Ground", "Ghost"],
		gender: "N",
		baseStats: {hp: 99, atk: 129, def: 85, spa: 50, spd: 85, spe: 55},
		abilities: {0: "Iron Fist", 1: "Klutz", H: "No Guard"},
		heightm: 2.8,
		weightkg: 330,
		color: "Green",
	...
	pawniard: {
		...
		abilities: {0: "Defiant", 1: "Inner Focus", H: "Last Stand"},
		heightm: 0.5,
		weightkg: 10.2,
		color: "Red",
		evos: ["Bisharp"],
		eggGroups: ["Human-Like"],
		otherFormes: ["Pawniard-Almia", "Pawniard-Kalos"],
        formeOrder: ["Pawniard", "Pawniard-Almia", "Pawniard-Kalos"],
	},
	pawniardalmia: {
		num: 624,
		name: "Pawniard-Almia",
		...
		baseStats: {hp: 45, atk: 80, def: 65, spa: 40, spd: 45, spe: 65},
		abilities: {0: "Frisk", 1: "Sand Rush", H: "Defiant"},
		heightm: 0.5,
		weightkg: 10.2,
		color: "Red",
		evos: ["Bisharp-Almia"],
	...
	bisharp: {
		...
		abilities: {0: "Defiant", 1: "Blade Master", H: "Last Stand"},
		heightm: 1.6,
		weightkg: 70,
		color: "Red",
		prevo: "Pawniard",
		evoLevel: 52,
		eggGroups: ["Human-Like"],
		otherFormes: ["Bisharp-Almia", "Bisharp-Kalos"],
        formeOrder: ["Bisharp", "Bisharp-Almia", "Bisharp-Kalos"],
	},
	bisharpkalos: {
		num: 625,
		name: "Bisharp-Kalos",
	...
	bisharpalmia: {
		...
		forme: "Almia",
		types: ["Ground", "Fighting"],
		baseStats: {hp: 65, atk: 115, def: 85, spa: 50, spd: 80, spe: 95},
		abilities: {0: "Frisk", 1: "Sand Rush", H: "Defiant"},
		heightm: 1.6,
		weightkg: 70,
		color: "Red",
		prevo: "Pawniard-Almia",
		evoLevel: 52,
		eggGroups: ["Human-Like"],
		newmeta: "true",
	},
	bouffalant: {
		...
		name: "Bouffalant",
		types: ["Normal"],
		baseStats: {hp: 95, atk: 120, def: 95, spa: 40, spd: 95, spe: 45},
	...
	vullaby: {
		...
		abilities: {0: "Early Bird", 1: "Overcoat", H: "Weak Armor"},
		heightm: 0.5,
		weightkg: 9,
		color: "Brown",
		evos: ["Mandibuzz"],
	...
	mandibuzz: {
		...
		abilities: {0: "Big Pecks", 1: "Overcoat", H: "Daunt"},
		heightm: 1.2,
		weightkg: 39.5,
		color: "Brown",
		prevo: "Vullaby",
	...
	heatmor: {
		...
		name: "Heatmor",
		types: ["Fire"],
		baseStats: {hp: 85, atk: 105, def: 66, spa: 105, spd: 66, spe: 65},
	...
	durant: {
		...
		color: "Gray",
		eggGroups: ["Bug"],
		otherFormes: ["Durant-Sinnoh"],
        formeOrder: ["Durant", "Durant-Sinnoh"],
	},
	deino: {
		num: 633,
		name: "Deino",
	...
	hydreigon: {
		...
		evoLevel: 64,
		eggGroups: ["Dragon"],
		otherFormes: ["Hydreigon-Hoenn"],
		formeOrder: ["Hydreigon", "Hydreigon-Hoenn"],
	},
	hydreigonhoenn: {
		num: 635,
		name: "Hydreigon-Hoenn",
		baseSpecies: "Hydreigon",
		forme: "Hoenn",
		types: ["Poison", "Ground"],
		baseStats: {hp: 98, atk: 105, def: 105, spa: 92, spd: 120, spe: 80},
	...
	larvesta: {
		...
		abilities: {0: "Flame Body", 1: "Sunray", H: "Swarm"},
		heightm: 1.1,
		weightkg: 28.8,
		color: "White",
		evos: ["Volcarona"],
	...
	cobalion: {
		...
		abilities: {0: "Justified", 1: "Blade Master", H: "Clear Body"},
		heightm: 2.1,
		weightkg: 250,
		color: "Blue",
		tags: ["Sub-Legendary"],
	...
	terrakion: {
		...
		abilities: {0: "Justified", 1: "Blade Master", H: "Fortitude"},
		heightm: 1.9,
		weightkg: 260,
		color: "Gray",
		tags: ["Sub-Legendary"],
	...
	virizion: {
		...
		abilities: {0: "Justified", 1: "Blade Master", H: "Quick Feet"},
		heightm: 2,
		weightkg: 200,
		color: "Green",
		tags: ["Sub-Legendary"],
	...
	//alternative meloetta starting as "pirouette"
	meloettapirouettan: {
		num: 648,
		name: "Meloetta-Pirouettan",
		baseForme: "Pirouettan",
		types: ["Normal", "Fighting"],
		gender: "N",
		baseStats: {hp: 100, atk: 128, def: 90, spa: 77, spd: 77, spe: 128},
		abilities: {0: "Serene Grace"},
		...
		color: "White",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Meloetta-Pirouettan-Arian"],
		formeOrder: ["Meloetta-Pirouettan", "Meloetta-Pirouettan-Arian"],
	},
	//alternative meloetta-pirouette "arian"
	meloettapirouettanarian: {
		num: 648,
		name: "Meloetta-Pirouettan-Arian",
		baseSpecies: "Meloetta-Pirouettan",
		forme: "Arian",
		types: ["Normal", "Psychic"],
		gender: "N",
		baseStats: {hp: 100, atk: 77, def: 77, spa: 128, spd: 128, spe: 90},
		...
		eggGroups: ["Undiscovered"],
		requiredMove: "Relic Song",
		battleOnly: "Meloetta-Pirouettan",
	},
	genesect: {
		num: 649,
		name: "Genesect",
	...
	chespin: {
		...
		abilities: {0: "Overgrow", 1: "Shell Armor", H: "Bulletproof"},
		heightm: 0.4,
		weightkg: 9,
		color: "Green",
		evos: ["Quilladin"],
	...
	litleo: {
		...
		abilities: {0: "Rivalry", 1: "Blaze Roar", H: "Hubris"},
		heightm: 0.6,
		weightkg: 13.5,
		color: "Brown",
		evos: ["Pyroar"],
	...
	pangoro: {
		...
		abilities: {0: "Iron Fist", 1: "Breakneck", H: "Scrappy"},
		heightm: 2.1,
		weightkg: 136,
		color: "White",
		prevo: "Pancham",
	...
	furfrou: {
		...
		baseForme: "Natural",
		types: ["Normal"],
		baseStats: {hp: 75, atk: 85, def: 70, spa: 60, spd: 80, spe: 102},
	...
	meowstic: {
		...
		types: ["Psychic"],
		gender: "M",
		baseStats: {hp: 80, atk: 48, def: 81, spa: 83, spd: 81, spe: 104},
	...
	meowsticf: {
		...
		gender: "F",
		baseStats: {hp: 80, atk: 48, def: 81, spa: 83, spd: 81, spe: 104},
		abilities: {0: "Keen Eye", 1: "Trace", H: "Competitive"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "White",
		prevo: "Espurr",
	...
	doublade: {
		...
		abilities: {0: "No Guard", 1: "Blade Master"},
		heightm: 0.8,
		weightkg: 4.5,
		color: "Brown",
		prevo: "Honedge",
	...
	aromatisse: {
		...
		name: "Aromatisse",
		types: ["Fairy"],
		baseStats: {hp: 105, atk: 72, def: 87, spa: 104, spd: 96, spe: 29},
		abilities: {0: "Healer", H: "Aroma Veil"},
		heightm: 0.8,
		weightkg: 15.5,
		color: "Pink",
	...
	skrelp: {
		...
		name: "Skrelp",
		types: ["Poison", "Water"],
		baseStats: {hp: 50, atk: 60, def: 60, spa: 70, spd: 60, spe: 30},
		abilities: {0: "Poison Point", 1: "Toxic Intake", H: "Adaptability"},
		heightm: 0.5,
		weightkg: 7.3,
		color: "Brown",
		evos: ["Dragalge"],
	...
	dragalge: {
		...
		name: "Dragalge",
		types: ["Poison", "Dragon"],
		baseStats: {hp: 65, atk: 75, def: 103, spa: 97, spd: 123, spe: 44},
		abilities: {0: "Poison Point", 1: "Toxic Intake", H: "Adaptability"},
		heightm: 1.8,
		weightkg: 81.5,
		color: "Brown",
	...
	aurorus: {
		...
		types: ["Rock", "Ice"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 123, atk: 73, def: 72, spa: 103, spd: 92, spe: 58},
		abilities: {0: "Refrigerate", H: "Snow Warning"},
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
	...
	avalugg: {
		...
		name: "Avalugg",
		types: ["Ice"],
		baseStats: {hp: 100, atk: 117, def: 184, spa: 44, spd: 74, spe: 20},
		abilities: {0: "Snow Packing", 1: "Ice Body", H: "Sturdy"},
		heightm: 2,
		weightkg: 505,
		color: "Blue",
		prevo: "Bergmite",
	...
	noibat: {
		...
		name: "Noibat",
		types: ["Flying", "Dragon"],
		baseStats: {hp: 45, atk: 30, def: 45, spa: 65, spd: 55, spe: 75},
	...
	volcanion: {
		...
		abilities: {0: "Water Absorb", 1: "Steam Power"},
		heightm: 1.7,
		weightkg: 195,
		color: "Brown",
		tags: ["Mythical"],
	...
	rowlet: {
		...
		abilities: {0: "Overgrow", 1: "Leaf Guard", H: "Long Reach"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "Brown",
		evos: ["Dartrix"],
	...
	decidueye: {
		...
		types: ["Grass", "Ghost"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 117, def: 85, spa: 70, spd: 79, spe: 101},
		abilities: {0: "Overgrow", 1: "Leaf Guard", H: "Long Reach"},
		heightm: 1.6,
		weightkg: 36.6,
		color: "Brown",
	...
	decidueyehisui: {
		...
		types: ["Grass", "Fighting"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 78, atk: 122, def: 85, spa: 65, spd: 89, spe: 91},
		abilities: {0: "Overgrow", 1:"Adaptability", H: "Long Reach"},
		heightm: 1.6,
		weightkg: 37,
		color: "Brown",
		prevo: "Dartrix",
	...
	popplio: {
		...
		abilities: {0: "Torrent", 1: "Wonder Skin", H: "Liquid Voice"},
		heightm: 0.4,
		weightkg: 7.5,
		color: "Blue",
		evos: ["Brionne"],
	...
	grubbin: {
		...
		evos: ["Charjabug"],
		eggGroups: ["Bug"],
		otherFormes: ["Grubbin-Unova"],
		formeOrder: ["Grubbin", "Grubbin-Unova"],
	},
	grubbinunova: {
		num: 736,
		name: "Grubbin-Unova",
	...
	charjabug: {
		...
		evos: ["Vikavolt"],
		eggGroups: ["Bug"],
		otherFormes: ["Charjabug-Unova"],
		formeOrder: ["Charjabug", "Charjabug-Unova"],
	},
	charjabugunova: {
		num: 737,
		name: "Charjabug-Unova",
		baseSpecies: "Charjabug",
		forme: "Unova",
		types: ["Bug", "Fire"],
		baseStats: {hp: 57, atk: 88, def: 95, spa: 55, spd: 75, spe: 36},
		abilities: {0: "Flame Body"},
		heightm: 0.5,
		weightkg: 10.5,
		color: "Green",
	...
	vikavolt: {
		...
		evoItem: "Thunder Stone",
		eggGroups: ["Bug"],
		otherFormes: ["Vikavolt-Unova", "Vikavolt-Totem"],
		formeOrder: ["Vikavolt", "Vikavolt-Unova", "Vikavolt-Totem"],
	},
	vikavoltunova: {
		num: 738,
		name: "Vikavolt-Unova",
		...
		forme: "Unova",
		types: ["Bug", "Fire"],
		baseStats: {hp: 70, atk: 80, def: 85, spa: 130, spd: 85, spe: 50},
		abilities: {0: "Steely Spirit"},
		heightm: 1.5,
		weightkg: 119.8,
		color: "Blue",
		prevo: "Charjabug-Unova",
		evoType: "useItem",
		evoItem: "Fire Stone",
		eggGroups: ["Bug"],
	},
	...
	cutiefly: {
		...
		abilities: {0: "Enchantment", 1: "Honey Gather", H: "Sweet Veil"},
		heightm: 0.1,
		weightkg: 0.2,
		color: "Yellow",
		evos: ["Ribombee"],
	...
	fomantis: {
		...
		abilities: {0: "Blade Master", H: "Contrary"},
		heightm: 0.3,
		weightkg: 1.5,
		color: "Pink",
		evos: ["Lurantis"],
	...
	lurantis: {
		...
		name: "Lurantis",
		types: ["Grass"],
		baseStats: {hp: 70, atk: 105, def: 90, spa: 80, spd: 90, spe: 80},
		abilities: {0: "Blade Master", H: "Contrary"},
		heightm: 0.9,
		weightkg: 18.5,
		color: "Pink",
	...
	shiinotic: {
		...
		name: "Shiinotic",
		types: ["Grass", "Light"],
		baseStats: {hp: 90, atk: 45, def: 80, spa: 90, spd: 100, spe: 30},
		abilities: {0: "Illuminate", 1: "Effect Spore", H: "Natural Cure"},
		heightm: 1,
		weightkg: 11.5,
		color: "Purple",
		prevo: "Morelull",
	...
	salandit: {
		...
		abilities: {0: "Corrosion", 1: "Hubris", H: "Pyrotoxin"},
		heightm: 0.6,
		weightkg: 4.8,
		color: "Black",
		evos: ["Salazzle"],
	...
	steenee: {
		...
		abilities: {0: "Kicker", 1: "Oblivious", H: "Sweet Veil"},
		heightm: 0.7,
		weightkg: 8.2,
		color: "Purple",
		prevo: "Bounsweet",
	...
	comfey: {
		...
		types: ["Fairy"],
		genderRatio: {M: 0.25, F: 0.75},
		baseStats: {hp: 51, atk: 52, def: 90, spa: 90, spd: 110, spe: 100},
	...
	passimian: {
		...
		abilities: {0: "Receiver", 1: "Artillery", H: "Defiant"},
		heightm: 2,
		weightkg: 82.8,
		color: "White",
		eggGroups: ["Field"],
	...
	palossand: {
		...
		name: "Palossand",
		types: ["Ghost", "Ground"],
		baseStats: {hp: 85, atk: 60, def: 115, spa: 110, spd: 85, spe: 35},
		abilities: {0: "Water Compaction", 1: "Sand Stream", H: "Sand Veil"},
		heightm: 1.3,
		weightkg: 250,
		color: "Brown",
	...
	pyukumuku: {
		...
		name: "Pyukumuku",
		types: ["Water"],
		baseStats: {hp: 65, atk: 60, def: 130, spa: 30, spd: 130, spe: 5},
	...
	silvallylight: {
		...
		color: "Gray",
		eggGroups: ["Undiscovered"],
		requiredItem: "Light Memory",
		changesFrom: "Silvally",
	},
	silvallycosmic: {
		num: 773,
		name: "Silvally-Cosmic",
		baseSpecies: "Silvally",
		forme: "Cosmic",
		types: ["Cosmic"],
		gender: "N",
	...
	turtonator: {
		...
		abilities: {0: "Shell Armor", 1: "Conflagrant"},
		heightm: 2,
		weightkg: 212,
		color: "Red",
		eggGroups: ["Monster", "Dragon"],
	...
	togedemaru: {
		...
		name: "Togedemaru",
		types: ["Electric", "Steel"],
		baseStats: {hp: 70, atk: 105, def: 63, spa: 40, spd: 80, spe: 96},
	...
	bruxish: {
		...
		name: "Bruxish",
		types: ["Water", "Psychic"],
		baseStats: {hp: 68, atk: 115, def: 70, spa: 90, spd: 70, spe: 107},
	...
	celesteela: {
		...
		abilities: {0: "Beast Boost", H: "Artillery"},
		heightm: 9.2,
		weightkg: 999.9,
		color: "Green",
		tags: ["Sub-Legendary"],
	...
	kartana: {
		...
		abilities: {0: "Beast Boost", H: "Blade Master"},
		heightm: 0.3,
		weightkg: 0.1,
		color: "White",
		tags: ["Sub-Legendary"],
	...
	magearnaoriginal: {
		...
		gender: "N",
		baseStats: {hp: 80, atk: 95, def: 115, spa: 130, spd: 115, spe: 65},
		abilities: {0: "Vital Spirit", H: "Soul-Heart"},
		heightm: 1,
		weightkg: 80.5,
		color: "Red",
		eggGroups: ["Undiscovered"],
	...
	poipole: {
		...
		abilities: {0: "Beast Boost", H: "Toxic Wasteland"},
		heightm: 0.6,
		weightkg: 1.8,
		color: "Purple",
		tags: ["Sub-Legendary"],
	...
	zeraora: {
		...
		abilities: {0: "Volt Absorb", 1: "Steadfast"},
		heightm: 1.5,
		weightkg: 44.5,
		color: "Yellow",
		tags: ["Mythical"],
	...
	scorbunny: {
		...
		abilities: {0: "Blaze", 1: "Kicker", H: "Libero"},
		heightm: 0.3,
		weightkg: 4.5,
		color: "White",
		evos: ["Raboot"],
	...
	inteleon: {
		...
		abilities: {0: "Torrent", 1: "Artillery", H: "Sniper"},
		heightm: 1.9,
		weightkg: 45.2,
		color: "Blue",
		prevo: "Drizzile",
	...
	blipbug: {
		...
		abilities: {0: "Swarm", 1: "Compound Eyes", H: "Orbital"},
		heightm: 0.4,
		weightkg: 8,
		color: "Blue",
		evos: ["Dottler"],
	...
	orbeetle: {
		...
		abilities: {0: "Swarm", 1: "Frisk", H: "Orbital"},
		heightm: 0.4,
		weightkg: 40.8,
		color: "Red",
		prevo: "Dottler",
	...
	rolycoly: {
		...
		abilities: {0: "Steam Engine", 1: "Heatproof", H: "Ignition"},
		heightm: 0.3,
		weightkg: 12,
		color: "Black",
		evos: ["Carkol"],
	...
	carkol: {
		...
		abilities: {0: "Steam Engine", 1: "Flame Body", H: "Ignition"},
		heightm: 1.1,
		weightkg: 78,
		color: "Black",
		prevo: "Rolycoly",
	...
	flapple: {
		...
		name: "Flapple",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 70, atk: 110, def: 80, spa: 110, spd: 60, spe: 75},
	...
	appletun: {
		...
		name: "Appletun",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 130, atk: 85, def: 80, spa: 100, spd: 80, spe: 30},
	...
	arrokuda: {
		...
		abilities: {0: "Swift Swim", 1: "Fish Memory", H: "Propeller Tail"},
		heightm: 0.5,
		weightkg: 1,
		color: "Brown",
		evos: ["Barraskewda"],
	...
	centiskorch: {
		...
		abilities: {0: "Flash Fire", 1: "Conflagrant", H: "Flame Body"},
		heightm: 3,
		weightkg: 120,
		color: "Red",
		prevo: "Sizzlipede",
	...
	grapploct: {
		...
		abilities: {0: "Limber", 1: "Chain Striker", H: "Technician"},
		heightm: 1.6,
		weightkg: 39,
		color: "Blue",
		prevo: "Clobbopus",
	...
	grimmsnarl: {
		...
		abilities: {0: "Prankster", 1: "Frisk", H: "Daunt"},
		heightm: 1.5,
		weightkg: 61,
		color: "Purple",
		prevo: "Morgrem",
	...
	perrserker: {
		...
		abilities: {0: "Last Stand", 1: "Tough Claws", H: "Steely Spirit"},
		heightm: 0.8,
		weightkg: 28,
		color: "Brown",
		prevo: "Meowth-Galar",
	...
	runerigus: {
		...
		abilities: {0: "Wandering Spirit", H: "Undead"},
		heightm: 1.6,
		weightkg: 66.6,
		color: "Gray",
		prevo: "Yamask-Galar",
	...
	alcremie: {
		...
		types: ["Fairy"],
		gender: "F",
		baseStats: {hp: 65, atk: 60, def: 75, spa: 110, spd: 121, spe: 94},
		abilities: {0: "Sweet Veil", 1: "Enchantment", H: "Aroma Veil"},
		heightm: 0.3,
		weightkg: 0.5,
		color: "White",
		prevo: "Milcery",
	...
	falinks: {
		...
		abilities: {0: "Battle Armor", 1: "Fortitude", H: "Defiant"},
		heightm: 3,
		weightkg: 62,
		color: "Yellow",
		eggGroups: ["Fairy", "Mineral"],
		otherFormes: ["Falinks-Oblivia"],
        formeOrder: ["Falinks", "Falinks-Oblivia"],
	},
	falinksoblivia: {
		num: 870,
		name: "Falinks-Oblivia",
		baseSpecies: "Falinks",
        forme: "Oblivia",
		types: ["Dark", "Steel"],
		gender: "N",
		baseStats: {hp: 65, atk: 100, def: 100, spa: 70, spd: 60, spe: 75},
		abilities: {0: "Scavenger", 1: "Artillery", H: "Skill Link"},
		heightm: 1.5,
		weightkg: 400,
		color: "Black",
		eggGroups: ["Fairy", "Mineral"],
	...
	pincurchin: {
		...
		name: "Pincurchin",
		types: ["Electric"],
		baseStats: {hp: 78, atk: 101, def: 95, spa: 91, spd: 85, spe: 15},
	...
	urshifurapidstrike: {
		...
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 100, atk: 120, def: 100, spa: 63, spd: 60, spe: 107},
		abilities: {0: "Unseen Fist"},
		heightm: 1.9,
		weightkg: 105,
		color: "Gray",
...
//},
	crawcomb: {
		...
		name: "Crawcomb",
		types: ["Bug", "Dragon"],
		baseStats: {hp: 80, atk: 120, def: 120, spa: 120, spd: 120, spe: 80},
		abilities: {0: "Klutz"},
		heightm: 1.5,
		weightkg: 100,
		color: "Green",
	...
	ibroxiz: {
		...
		name: "Ibroxiz",
		types: ["Steel", "Poison"],
		baseStats: {hp: 40, atk: 65, def: 90, spa: 45, spd: 60, spe: 10},
		abilities: {0: "Corrosion", H: "Aftermath"},
		heightm: 2.1,
		weightkg: 142,
		color: "White",
		evos: ["wicketox"],
	...
	delibirdgalar: {
		...
		forme: "Galar",
		types: ["Rock", "Fire"],
		baseStats: {hp: 60, atk: 55, def: 80, spa: 65, spd: 75, spe: 95},
		abilities: {0: "Huge Power", 1: "Vital Spirit", H: "Flame Body"},
		heightm: 0.9,
		weightkg: 16,
		color: "Black",
		eggGroups: ["Water 1", "Field"],
	...
	skulpent: {
		...
		name: "Skulpent",
		types: ["Ghost", "Rock"],
		baseStats: {hp: 75, atk: 120, def: 90, spa: 50, spd: 60, spe: 105},
	...
	narpoon: {
		...
		abilities: {0: "Light Metal", 1: "Hustle", H: "Long Reach"},
		heightm: 3,
		weightkg: 100,
		color: "Blue",
		eggGroups: ["Water 1", "Field"],
	...
	muuthate: {
		...
		name: "Muuthate",
		types: ["Ice", "Fire"],
		baseStats: {hp: 99, atk: 116, def: 95, spa: 55, spd: 75, spe: 85},
		abilities: {0: "Snow Packing", 1: "Mountaineer", H: "Mold Breaker"},
		heightm: 6.4,
		weightkg: 114,
		color: "Red",
		eggGroups: ["Water 1", "Field"],
	...
	vampayar: {
		...
		name: "Vampayar",
		types: ["Water", "Dark"],
		baseStats: {hp: 80, atk: 105, def: 80, spa: 50, spd: 80, spe: 90},
		abilities: {0: "Strong Jaw", 1: "Blood Sucker", H: "Predatory Instinct"},
		heightm: 1.3,
		weightkg: 59,
		color: "Blue",
		eggGroups: ["Water 1", "Field"],
	...
	flamake: {
		...
		name: "Flamake",
		types: ["Fire"],
		baseStats: {hp: 55, atk: 60, def: 50, spa: 30, spd: 65 , spe: 40},
	...
	debikku: {
		...
		name: "Debikku",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 85, atk: 70, def: 70, spa: 40, spd: 105 , spe: 50},
		abilities: {0: "Blaze", 1: "Shed Skin", H: "Cloud Nine"},
		heightm: 1.5,
		weightkg: 25,
		color: "Yellow",
	...
	ribbostuma: {
		...
		name: "Ribbostuma",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 105, atk: 60, def: 95, spa: 80, spd: 125 , spe: 65},
		abilities: {0: "Blaze", 1: "Shed Skin", H: "Cloud Nine"},
		heightm: 4.4,
		weightkg: 68,
		color: "Yellow",
	...
	vekurrent: {
		...
		name: "Vekurrent",
		types: ["Flying"],
		baseStats: {hp: 75, atk: 53, def: 78, spa: 107, spd: 94, spe: 123},
		abilities: {0: "Strong Winds", 1: "Oblivious", H: "Aerilate"},
		heightm: 4.4,
		weightkg: 68,
		color: "Yellow",
		eggGroups: ["Field"],
	...
	lustreon: {
		...
		abilities: {0: "Radiance", 1: "Illuminate", H: "Dazzling"},
		heightm: 0.8,
		weightkg: 24.5,
		color: "Yellow",
		prevo: "Eevee",
	...
	durantsinnoh: {
		...
		name: "Durant-Sinnoh",
		types: ["Bug", "Ice"],
		baseStats: {hp: 78, atk: 109, def: 68, spa: 48, spd: 112, spe: 69},
		abilities: {0: "Snow Packing", 1: "Ice Body", H: "Fortitude"},
		heightm: 0.3,
		weightkg: 68,
		color: "White",
		eggGroups: ["Field"],
	...
	refleki: {
		...
		name: "Refleki",
		types: ["Poison"],
		baseStats: {hp: 45, atk: 30, def: 45, spa: 60, spd: 45, spe: 35},
	...
	konipole: {
		...
		name: "Konipole",
		types: ["Ground"],
		baseStats: {hp: 55, atk: 47, def: 70, spa: 65, spd: 50, spe: 33},
		abilities: {0: "Immunity", 1: "Thick Fat", H: "Friend Guard"},
		heightm: 0.3,
		weightkg: 30,
		color: "Brown",
		evos: ["Kroprinz"],
	...
	kroprinz: {
		...
		name: "Kroprinz",
		types: ["Ground", "Fairy"],
		baseStats: {hp: 75, atk: 77, def: 100, spa: 85, spd: 60, spe: 43},
		abilities: {0: "Immunity", 1: "Thick Fat", H: "Friend Guard"},
		heightm: 1.2,
		weightkg: 70,
		color: "Pink",
	...
	froschaiser: {
		...
		name: "Froschaiser",
		types: ["Ground", "Fairy"],
		baseStats: {hp: 95, atk: 87, def: 120, spa: 105, spd: 90, spe: 63},
	...
	corchi: {
		...
		abilities: {0: "Keen Eye", 1: "Telepathy", H: "Tinted Lens"},
		heightm: 1.6,
		weightkg: 40,
		color: "Pink",
		eggGroups: ["Field"],
	...
	wahgon: {
		...
		name: "Wahgon",
		types: ["Normal"],
		baseStats: {hp: 45, atk: 60, def: 25, spa: 45, spd: 25, spe: 45},
		abilities: {0: "Overcoat", 1: "Steadfast", H: "Rattled"},
		heightm: 1.4,
		weightkg: 6.9,
		color: "Brown",
		evos: ["Caravagon"],
	...
	caravagon: {
		...
		name: "Caravagon",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 90, atk: 110, def: 70, spa: 95, spd: 70, spe: 100},
	...
	immosstor: {
		...
		name: "Immosstor",
		types: ["Rock", "Grass"],
		baseStats: {hp: 90, atk: 130, def: 145, spa: 50, spd: 85, spe: 30},
	...
	spiritute: {
		...
		name: "Spiritute",
		types: ["Ghost", "Normal"],
		baseStats: {hp: 60, atk: 50, def: 110, spa: 50, spd: 110, spe: 20},
	...
	smackafaun: {
		...
		name: "Smackafaun",
		types: ["Fairy", "Rock"],
		baseStats: {hp: 76, atk: 137, def: 137, spa: 50, spd: 50, spe: 100},
		abilities: {0: "Defiant", 1: "Sturdy", H: "Mountaineer"},
		heightm: 1.8,
		weightkg: 121,
		color: "Brown",
		eggGroups: ["Field"],
	...
	cervumis: {
		...
		name: "Cervumis",
		types: ["Fairy", "Fighting"],
		baseStats: {hp: 100, atk: 75, def: 90, spa: 120, spd: 80, spe: 115},
		abilities: {0: "Mythic Archer", 1: "Pantheon", H: "Competitive"},
		heightm: 1.9,
		weightkg: 80,
		color: "Pink",
		eggGroups: ["Field"],
	...
	kamisparce: {
		...
		name: "Kamisparce",
		types: ["Normal", "Dragon"],
		baseStats: {hp: 140, atk: 100, def: 85, spa: 70, spd: 80, spe: 55},
		abilities: {0: "Serene Grace", 1: "Limber", H: "Levitate"},
		heightm: 5.5,
		weightkg: 160,
		color: "White",
		prevo: "Dunsparce",
	...
	kyteroids: {
		...
		name: "Kyteroids",
		types: ["Ice", "Cosmic"],
		baseStats: {hp: 74, atk: 71, def: 71, spa: 110, spd: 74, spe: 137},
		abilities: {0: "Chain Striker", 1: "Levitate", H: "Skill Link"},
		heightm: 1.9,
		weightkg: 80,
		color: "Grey",
		eggGroups: ["Field"],
	...
	aracnicold: {
		...
		abilities: {0: "Slush Rush", 1: "Weak Armor", H: "Merciless"},
		heightm: 1.9,
		weightkg: 80,
		color: "Purple",
		eggGroups: ["Field"],
	...
	plesiolith: {
		...
		name: "Plesiolith",
		types: ["Water", "Rock"],
		baseStats: {hp: 71, atk: 65, def: 85, spa: 125, spd: 74, spe: 115},
		abilities: {0: "Swift Swim", 1: "Sand Force", H: "Overcoat"},
		heightm: 1.9,
		weightkg: 80,
		color: "Grey",
		eggGroups: ["Field"],
	...
	terraloosa: {
		...
		abilities: {0: "Orbital", 1: "Grass Pelt"},
		heightm: 1.9,
		weightkg: 80,
		color: "Grey",
		eggGroups: ["Field"],
	...
	rauchick: {
		...
		name: "Rauchick",
		types: ["Normal", "Fire"],
		baseStats: {hp: 55, atk: 60, def: 45, spa: 75, spd: 50, spe: 65},
		abilities: {0: "Keen Eye", 1: "Rattled"},
		heightm: 0.3,
		weightkg: 1.8,
		color: "Red",
		evos: ["Symphonix"],
	...
	symphonix: {
		...
		name: "Symphonix",
		types: ["Normal", "Fire"],
		baseStats: {hp: 90, atk: 90, def: 70, spa: 120, spd: 80, spe: 105},
		abilities: {0: "Levitate", 1: "Orchestral"},
		heightm: 0.8,
		weightkg: 8.5,
		color: "Red",
		prevo: "Rauchick",
	...
	sunbardier: {
		...
		abilities: {0: "Artillery", 1: "Solar Power", H: "Rooted"},
		heightm: 1.7,
		weightkg: 60,
		color: "Yellow",
		prevo: "Sunflora",
	...
	jorblazox: {
		...
		name: "Jorblazox",
		types: ["Poison", "Fire"],
		baseStats: {hp: 110, atk: 150, def: 90, spa: 125, spd: 110, spe: 95},
		abilities: {0: "Magic Guard", 1: "Shed Skin"},
		heightm: 1.9,
		weightkg: 80,
		color: "Grey",
		eggGroups: ["Field"],
	...
	woopa: {
		...
		types: ["Water", "Ground"],
		gender: "N",
		baseStats: {hp: 110, atk: 90, def: 90, spa: 50, spd: 50, spe: 30},
		abilities: {0: "Unaware"},
		heightm: 0.4,
		weightkg: 8.5,
		color: "Blue",
		eggGroups: ["Undiscovered"],
		otherFormes: ["Woopa-Unbound"],
		formeOrder: ["Woopa", "Woopa-Unbound"],
		newmeta: "true",
    },
    woopaunbound: {
		num: 10037,
		...
		types: ["Water", "Ground"],
		gender: "N",
		baseStats: {hp: 150, atk: 180, def: 120, spa: 69, spd: 100, spe: 131},
		abilities: {0: "Unaware"},
		heightm: 6.4,
		weightkg: 489.5,
		color: "Blue",
	...
	fortuxin: {
		...
		baseStats: {hp: 75, atk: 50, def: 90, spa: 130, spd: 95, spe: 40},
		abilities: {0: "Inner Focus", 1: "Trace", H: "Visionary"},
		heightm: 3.4,
		weightkg: 31,
		color: "Purple",
		eggGroups: ["Field"],
	...
	sabrenom: {
		...
		name: "Sabrenom",
		types: ["Ice", "Poison"],
		baseStats: {hp: 71, atk: 125, def: 90, spa: 50, spd: 65, spe: 74},
		abilities: {0: "Strong Jaw", H: "Poison Touch"},
		heightm: 6,
		weightkg: 177,
		color: "White",
		eggGroups: ["Field"],
	...
	mossedge: {
		...
		name: "Mossedge",
		types: ["Ground", "Grass"],
		baseStats: {hp: 100, atk: 120, def: 120, spa: 55, spd: 70, spe: 80},
		abilities: {0: "Grass Pelt", 1: "Camper", H: "Rough Skin"},
		heightm: 6,
		weightkg: 177,
		color: "Green",
		eggGroups: ["Field"],
	...
	beatboon: {
		...
		baseStats: {hp: 87, atk: 127, def: 42, spa: 117, spd: 67, spe: 107},
		abilities: {0: "Dancer", H: "Soundproof"},
		heightm: 6,
		weightkg: 177,
		color: "White",
		eggGroups: ["Field"],
	...
	helmelime: {
		...
		name: "Helmelime",
		types: ["Poison", "Steel"],
		baseStats: {hp: 65, atk: 45, def: 55, spa: 15, spd: 65, spe: 55},
		abilities: {0: "Regenerator", 1: "Battle Armor", H: "Sticky Hold"},
		heightm: 0.3,
		weightkg: 3,
		color: "Green",
		evos: ["Sliarmor"],
	...
	sliarmor: {
		...
		name: "Sliarmor",
		types: ["Poison", "Steel"],
		baseStats: {hp: 80, atk: 82, def: 72, spa: 40, spd: 85, spe: 61},
		abilities: {0: "Regenerator", 1: "Battle Armor", H: "Sticky Hold"},
		heightm: 1.2,
		weightkg: 11,
		color: "Green",
	...
	cheslime: {
		...
		name: "Cheslime",
		types: ["Poison", "Steel"],
		baseStats: {hp: 120, atk: 117, def: 75, spa: 50, spd: 75, spe: 66},
		abilities: {0: "Regenerator", 1: "Battle Armor", H: "Blade Master"},
		heightm: 2.1,
		weightkg: 21,
		color: "Green",
		prevo: "Sliarmor",
	...
	leamyst: {
		...
		name: "Leamyst",
		types: ["Bug", "Fairy"],
		baseStats: {hp: 70, atk: 60, def: 50, spa: 90, spd: 120, spe: 90},
		abilities: {0: "Misty Surge", 1: "Enchantment", H: "Regenerator"},
		heightm: 6,
		weightkg: 177,
		color: "White",
		eggGroups: ["Field"],
	...
	shamblock: {
		...
		name: "Shamblock",
		types: ["Grass", "Fighting"],
		baseStats: {hp: 90, atk: 100, def: 110, spa: 50, spd: 95, spe: 50},
		abilities: {0: "Scrappy", 1: "Iron Fist", H: "Grassy Gloves"},
		heightm: 0.5,
		weightkg: 40,
		color: "Green",
		eggGroups: ["Field"],
	...
	pyratrata: {
		...
		name: "Pyratrata",
		types: ["Ghost", "Bug"],
		baseStats: {hp: 100, atk: 75, def: 60, spa: 110, spd: 90, spe: 95},
		abilities: {0: "Flare Boost", 1: "Swarm", H: "Undead"},
		heightm: 0.5,
		weightkg: 40,
		color: "Green",
		eggGroups: ["Field"],
	...
	sapogro: {
		...
		name: "Sapogro",
		types: ["Grass", "Water"],
		baseStats: {hp: 65, atk: 90, def: 65, spa: 90, spd: 65, spe: 135},
		abilities: {0: "Illuminate", 1: "Soundproof", H: "Poison Heal"},
		heightm: 0.5,
		weightkg: 40,
		color: "Red",
		eggGroups: ["Field"],
	...
	platyber: {
		...
		name: "Platyber",
		types: ["Water", "Ground"],
		baseStats: {hp: 80, atk: 69, def: 75, spa: 125, spd: 80, spe: 101},
		abilities: {0: "Artillery", 1: "Immunity", H: "Hydration"},
		heightm: 0.5,
		weightkg: 40,
		color: "Blue",
		eggGroups: ["Field"],
	...
	shadrimoke: {
		...
		name: "Shadrimoke",
		types: ["Ghost", "Dark"],
		baseStats: {hp: 85, atk: 55, def: 65, spa: 125, spd: 130, spe: 80},
		abilities: {0: "Imitation", 1: "White Smoke", H: "Remorse"},
		heightm: 0.5,
		weightkg: 40,
		color: "Grey",
		eggGroups: ["Field"],
...
//		num: 10052,
	...
	yetitan: {
		...
		baseForme: "Neutral",
		types: ["Ice", "Dark"],
		baseStats: {hp: 95, atk: 110, def: 80, spa: 70, spd: 100, spe: 80},
		abilities: {0: "Blizzard Gift"},
		heightm: 0.5,
		weightkg: 9.3,
		color: "White",
		eggGroups: ["Fairy", "Grass"],
		otherFormes: ["Yetitan-Blizzard"],
		formeOrder: ["Yetitan", "Yetitan-Blizzard"],
		newmeta: "true",
	},
	yetitanblizzard: {
		num: 10054,
		name: "Yetitan-Blizzard",
		baseSpecies: "Yetitan",
		forme: "Blizzard",
		types: ["Ice", "Dark"],
	...
	chefuego: {
		...
		name: "Chefuego",
		types: ["Fire", "Fairy"],
		baseStats: {hp: 90, atk: 70, def: 100, spa: 90, spd: 110, spe: 64},
		abilities: {0: "Aroma Veil", 1: "Keen Eye", H: "Regenerator"},
		heightm: 0.5,
		weightkg: 40,
		color: "Pink",
		eggGroups: ["Field"],
	...
	wizzard: {
		...
		name: "Wizzard",
		types: ["Ice", "Electric"],
		baseStats: {hp: 90, atk: 80, def: 75, spa: 117, spd: 90, spe: 108},
		abilities: {0: "Ice Body", 1: "Trace", H: "Sorcerers Curse"},
		heightm: 0.5,
		weightkg: 40,
		color: "Blue",
		eggGroups: ["Field"],
	...
	bidree: {
		...
		abilities: {0: "Magician", 1: "Synchronize", H: "Power of Alchemy"},
		heightm: 0.7,
		weightkg: 16,
		color: "Blue",
		eggGroups: ["Field"],
	...
	djiarana: {
		...
		abilities: {0: "Steam Power", 1: "Hydration", H: "Water Veil"},
		heightm: 2.2,
		weightkg: 106.6,
		color: "Blue",
		eggGroups: ["Human-Like"],
	...
	mirrorus: {
		...
		abilities: {0: "Poison Point", 1: "Multiscale", H: "Mirror Armor"},
		heightm: 2.7,
		weightkg: 225,
		color: "Blue",
		eggGroups: ["Amorphous"],
	...
	jestrick:{
		...
		abilities: {0: "Prankster", 1: "Cursed Body", H: "Contrary"},
		heightm: 0.2,
		weightkg: 0.4,
		color: "Purple",
		eggGroups: ["Amorphous"],
	...
	battaby: {
		...
		name: "Battaby",
		types: ["Fighting"],
		baseStats: {hp: 40, atk: 68, def: 45, spa: 35, spd: 45, spe: 77},
		abilities: {0: "Vital Spirit", H: "Guts"},
		heightm: 0.5,
		weightkg: 40,
		color: "Brown",
		evos: ["Cuttaroo"],
	...
	glaciator: {
		...
		name: "Glaciator",
		types: ["Fighting", "Ice"],
		baseStats: {hp: 80, atk: 116, def: 80, spa: 83, spd: 75, spe: 96},
		abilities: {0: "Ice Body", H: "No Guard"},
		heightm: 1.9,
		weightkg: 80,
		color: "White",
		eggGroups: ["Field"],
	...
	xiphuno: {
		...
		name: "Xiphuno",
		types: ["Water", "Steel"],
		baseStats: {hp: 75, atk: 60, def: 35, spa: 30, spd: 35, spe: 65},
		abilities: {0: "Pressure", 1: "Light Metal", H: "Vitality Drain"},
		heightm: 0.3,
		weightkg: 20,
		color: "Blue",
		evos: ["Gladiduo"],
	...
	gladiduo: {
		...
		abilities: {0: "Pressure", 1:"Twinned", H: "Vitality Drain"},
		heightm: 0.7,
		weightkg: 42,
		color: "Blue",
		prevo: "Xiphuno",
	...
	gladorda: {
		...
		name: "Gladorda",
		types: ["Water", "Steel"],
		baseStats: {hp: 119, atk: 116, def: 80, spa: 95, spd: 80, spe: 110},
		abilities: {0: "Pressure", 1: "Twinned", H: "Vitality Drain"},
		heightm: 2.1,
		weightkg: 136,
		color: "Blue",
...
//	},
	//coleoterramega: {
		//num: 10080,
	//	name: "Coleoterra-Mega",
		//forme: "Mega",
	//	types: ["Bug", "Ground"],
	//	baseStats: {hp: 75, atk: 142, def: 128, spa: 65, spd: 91, spe: 109},
	//	abilities: {0: "Carapace"},
	//	heightm: 1.8,
	//	weightkg: 68,
	//	color: "Green",
	//	eggGroups: ["Bug"],
	//	requiredItem: "Coleoterite",
	//	newmeta: "true",
	//},
	optikwill: {
		num: 10081,
...
//		name: "Gyozito",
//		types: ["Electric", "Grass"],
//		baseStats: {hp: 75, atk: 48, def: 60, spa: 53, spd: 79, spe: 90},
//		abilities: {0: "Huge Power", 1: "Dynamo"},
//		heightm: 0.5,
//		weightkg: 32,
//		color: "Yellow",
//		eggGroups: ["Field"],
...
//	},
	nucleid: {
		...
		abilities: {0: "Aftermath", 1: "Radioactive"},
		heightm: 0.9,
		weightkg: 52,
		color: "Blue",
		evos: ["Calamitari"],
...
//		name: "Crustocion",
//		types: ["Ground", "Steel"],
//		baseStats: {hp: 70, atk: 70, def: 117, spa: 103, spd: 90, spe: 55},
...
//	},
	novisage: {
		...
		abilities: {0: "Beast Boost", H: "Flame Body"},
		heightm: 3.9,
		weightkg: 134,
		color: "Red",
		eggGroups: ["Undiscovered"],
...
//	mezoped: {
	...
	//	abilities: {0: "Reckless", 1: "Rushdown"},
	//	heightm: 0.8,
	//	weightkg: 62,
	//	color: "Green",
	//	eggGroups: ["Field"],
...
//		abilities: {0: "Solid Footing", H: "Natural Cure"},
//		heightm: 4.2,
//		weightkg: 150,
//		color: "Green",
//		eggGroups: ["Undiscovered"],
...
//	},
	...
	maliceros: {
		...
		name: "Maliceros",
		types: ["Dark", "Ground"],
		baseStats: {hp: 90, atk: 125, def: 120, spa: 60, spd: 75, spe: 64},
		abilities: {0: "Klutz", 1: "Weak Armor", H: "Sheer Force"},
		heightm: 1.1,
		weightkg: 80,
		color: "Black",
		eggGroups: ["Water 2"],
	...
	breechon: {
		...
		name: "Breechon",
		types: ["Flying"],
		baseStats: {hp: 65, atk: 70, def: 40, spa: 47, spd: 30, spe: 70},
		abilities: {0: "Cloud Nine", 1: "Run Away", H: "Aerilate"},
		heightm: 0.4,
		weightkg: 3,
		color: "White",
		evos: ["Nimbichon"],
	...
	nimbichon: {
		...
		name: "Nimbichon",
		types: ["Flying"],
		baseStats: {hp: 110, atk: 100, def: 70, spa: 85, spd: 55, spe: 100},
		abilities: {0: "Cloud Nine", 1: "Run Away", H: "Aerilate"},
		heightm: 0.8,
		weightkg: 6,
		color: "White",
	...
	leviorca: {
		...
		name: "Leviorca",
		types: ["Water", "Dragon"],
		baseStats: {hp: 96, atk: 97, def: 70, spa: 80, spd: 88, spe: 101},
		abilities: {0: "Torrent", 1: "Competitive", H: "Fish Memory"},
		heightm: 1.7,
		weightkg: 120,
		color: "Blue",
	...
	squimshi: {
		...
		name: "Squimshi",
		types: ["Fairy", "Ground"],
		baseStats: {hp: 80, atk: 70, def: 40, spa: 25, spd: 45, spe: 65},
		abilities: {0: "Shield Dust", 1: "Sticky Hold", H: "Gluttony"},
		heightm: 0.2,
		weightkg: 5,
		color: "Green",
		evos: ["Gummelid"],
	...
	gummelid: {
		...
		name: "Gummelid",
		types: ["Fairy", "Ground"],
		baseStats: {hp: 120, atk: 110, def: 70, spa: 50, spd: 75, spe: 95},
		abilities: {0: "Aroma Veil", 1: "Sticky Hold", H: "Gluttony"},
		heightm: 2.2,
		weightkg: 80,
		color: "Green",
		prevo: "Squimshi",
...
//	alivolt: {
	...
	//	name: "Alivolt",
	//	types: ["Electric", "Ghost"],
	//	baseStats: {hp: 95, atk: 113, def: 71, spa: 75, spd: 87, spe: 109},
	//	abilities: {0: "Dynamo", 1: "Super Luck", H: "Thunder Delight"},
	//	heightm: 0.8,
	//	weightkg: 50,
	//	color: "Blue",
	//	eggGroups: ["Field", "Monster"],
...
//	},
	fintricity: {
		...
		name: "Fintricity",
		types: ["Electric", "Water"],
		baseStats: {hp: 100, atk: 60, def: 85, spa: 75, spd: 80, spe: 90},
		abilities: {0: "Motor Drive", 1: "Swift Swim", H: "Volt Absorb"},
		heightm: 0.7,
		weightkg: 30,
		color: "Blue",
		eggGroups: ["Water 2"],
	...
	terrator: {
		...
		name: "Terrator",
		types: ["Ghost", "Ground"],
		baseStats: {hp: 87, atk: 112, def: 79, spa: 56, spd: 79, spe: 90},
		abilities: {0: "Defiant", 1: "Sniper", H: "Immunity"},
		heightm: 0.7,
		weightkg: 60,
		color: "Black",
		eggGroups: ["Field"],
...
//	},
	teracotoad: {
		...
		name: "Teracotoad",
		types: ["Ground", "Psychic"],
		baseStats: {hp: 70, atk: 60, def: 95, spa: 110, spd: 115, spe: 50},
		abilities: {0: "Rain Dish", 1: "Bulletproof", H: "Solid Rock"},
		heightm: 2.1,
		weightkg: 100,
		color: "Brown",
		prevo: "Tadpot",
	...
	copperfish: {
		...
		name: "Copperfish",
		types: ["Bug", "Electric"],
		baseStats: {hp: 36, atk: 56, def: 63, spa: 36, spd: 40, spe: 74},
		abilities: {0: "Minus", 1: "Volt Absorb", H: "Gluttony"},
		heightm: 0.9,
		weightkg: 30,
		color: "Brown",
	...
	cabiapod: {
		...
		name: "Cabiapod",
		types: ["Bug", "Electric"],
		baseStats: {hp: 64, atk: 111, def: 99, spa: 101, spd: 76, spe: 74},
		abilities: {0: "Minus", 1: "Volt Absorb", H: "Gluttony"},
		heightm: 1.6,
		weightkg: 70,
		color: "Brown",
	...
	kobyss: {
		...
		name: "Kobyss",
		types: ["Flying"],
		baseStats: {hp: 45, atk: 56, def: 38, spa: 42, spd: 39, spe: 53},
		abilities: {0: "Big Pecks", 1: "Natural Cure", H: "Toxic Intake"},
		heightm: 0.4,
		weightkg: 10,
		color: "Black",
		evos: ["Amputabis"],
	...
	amputabis: {
		...
		name: "Amputabis",
		types: ["Flying", "Dark"],
		baseStats: {hp: 51, atk: 84, def: 62, spa: 50, spd: 67, spe: 71},
		abilities: {0: "Big Pecks", 1: "Natural Cure", H: "Toxic Intake"},
		heightm: 1,
		weightkg: 36,
		color: "Black",
	...
	illarague: {
		...
		name: "Illarague",
		types: ["Flying", "Dark"],
		baseStats: {hp: 78, atk: 106, def: 72, spa: 68, spd: 79, spe: 95},
		abilities: {0: "Big Pecks", 1: "Natural Cure", H: "Toxic Intake"},
		heightm: 1.4,
		weightkg: 48,
		color: "Black",
	...
	cisnevous: {
		...
		name: "Cisnevous",
		types: ["Dark", "Flying"],
		baseStats: {hp: 71, atk: 90, def: 70, spa: 100, spd: 66, spe: 100},
		abilities: {0: "Envious", 1: "Hubris", H: "Swift Swim"},
		heightm: 1,
		weightkg: 40,
		color: "Black",
		eggGroups: ["Flying"],
	...
	jellop: {
		...
		name: "Jellop",
		types: ["Water", "Fighting"],
		baseStats: {hp: 68, atk: 97, def: 80, spa: 65, spd: 65, spe: 105},
		abilities: {0: "Poison Touch", 1: "Guts", H: "Hydration"},
		heightm: 1.4,
		weightkg: 2,
		color: "Blue",
		prevo: "Wallo",
...
//	serpens: {
	...
	//	name: "Serpens",
	//	types: ["Cosmic", "Poison"],
	//	baseStats: {hp: 70, atk: 70, def: 66, spa: 117, spd: 99, spe: 108},
	//	abilities: {0: "Liquid Ooze", 1: "Poison Cloak", H: "Radioactive"},
	//	heightm: 20.5,
	//	weightkg: 800,
	//	color: "Blue",
//		eggGroups: ["Undiscovered"],
...
//	},
	shrimpulse: {
		...
		name: "Shrimpulse",
		types: ["Electric"],
		baseStats: {hp: 70, atk: 65, def: 79, spa: 118, spd: 92, spe: 90},
		abilities: {0: "Technician", 1: "Telepathy", H: "Surge Surfer"},
		heightm: 0.2,
		weightkg: 1,
		color: "Yellow",
		eggGroups: ["Water 1"],
	...
	//	name: "Lavolley",
	//	types: ["Fire", "Water"],
	//	baseStats: {hp: 50, atk: 100, def: 60, spa: 97, spd: 40, spe: 98},
	//	abilities: {0: "Competitive", H: "Inner Focus"},
	//	heightm: 1.3,
	//	weightkg: 124,
	//	color: "Red",
...
//	},
	...
	moochick: {
		...
		name: "Moochick",
		types: ["Normal", "Flying"],
		baseStats: {hp: 70, atk: 85, def: 90, spa: 85, spd: 70, spe: 45},
		abilities: {0: "Gluttony", 1: "Pickpocket", H: "Unaware"},
		heightm: 1.3,
		weightkg: 50,
		color: "Brown",
		evos: ["Mespine"],
	...
	crawdozer: {
		...
		name: "Crawdozer",
		types: ["Bug"],
		baseStats: {hp: 130, atk: 125, def: 78, spa: 60, spd: 76, spe: 71},
		abilities: {0: "Solid Footing", 1: "Rebound", H: "Double Down"},
		heightm: 4.5,
		weightkg: 500,
		color: "Green",
	...
	porkano: {
		...
		name: "Porkano",
		types: ["Grass", "Fire"],
		baseStats: {hp: 121, atk: 80, def: 85, spa: 91, spd: 80, spe: 43},
		abilities: {0: "Drought", 1: "Mountaineer", H: "Harvest"},
		heightm: 2.2,
		weightkg: 460,
		color: "Green",
		eggGroups: ["Field", "Mineral"],
	...
	stallora: {
		...
		name: "Stallora",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 96, atk: 108, def: 72, spa: 61, spd: 101, spe: 82},
...
//	marshlugg: {
	...
	//	name: "Marshlugg",
	//	types: ["Ground"],
	//	baseStats: {hp: 107, atk: 54, def: 95, spa: 74, spd: 110, spe: 35},
	//	abilities: {0: "Dry Skin", H: "Gluttony"},
	//	heightm: 2.8,
	//	weightkg: 592,
	//	color: "Brown",
	//	eggGroups: ["Field", "Mineral"],
...
//	},
	kleptick: {
		...
		name: "Kleptick",
		types: ["Bug", "Dark"],
		baseStats: {hp: 45, atk: 85, def: 60, spa: 40, spd: 50, spe: 75},
	...
	scorpiohm: {
		...
		name: "Scorpiohm",
		types: ["Ground", "Electric"],
		baseStats: {hp: 90, atk: 73, def:92, spa: 109, spd: 101, spe: 61},
		abilities: {0: "Mega Launcher", 1: "Compound Eyes", H: "Sunbathe"},
		heightm: 1.2,
		weightkg: 1.3,
		color: "Brown",
		eggGroups: ["Bug", "Monster"],
	...
	nymper: {
		...
		name: "Nymper",
		types: ["Bug"],
		baseStats: {hp: 20, atk: 35, def: 35, spa: 20, spd: 30, spe: 50},
		abilities: {0: "Swarm", H: "Sturdy"},
		heightm: 0.1,
		weightkg: 0.2,
		color: "Brown",
		evos: ["Shientis"],
	...
	shientis: {
		...
		name: "Shientis",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 40, atk: 62, def: 74, spa: 40, spd: 65, spe: 57},
		abilities: {0: "Shield Dust", H: "Sturdy"},
		heightm: 0.5,
		weightkg: 10,
		color: "Brown",
		prevo: "Nymper",
	...
	martiartis: {
		...
		name: "Martiartis",
		types: ["Bug", "Fighting"],
		baseStats: {hp: 75, atk: 111, def: 90, spa: 60, spd: 68, spe: 96},
		abilities: {0: "Steelworker", H: "Sturdy"},
		heightm: 1.2,
		weightkg: 40,
		color: "Brown",
		prevo: "Shientis",
	...
	pyrilum: {
		...
		name: "Pyrilum",
		types: ["Grass", "Fire"],
		baseStats: {hp: 85, atk: 100, def: 65, spa: 115, spd: 70, spe: 95},
		abilities: {0: "Flower Veil", H: "Solar Power"},
		heightm: 1.2,
		weightkg: 30,
		color: "Green",
		eggGroups: ["Field"],
	...
	grandour: {
		...
		name: "Grandour",
		types: ["Normal", "Steel"],
		baseStats: {hp: 106, atk: 83, def: 98, spa: 82, spd: 97, spe: 54},
		abilities: {0: "Adaptability", H: "Steadfast"},
		heightm: 1.1,
		weightkg: 70,
		color: "Brown",
		eggGroups: ["Amorphous"],
	...
	croagunklokura: {
		num: 453,
		name: "Croagunk-Lokura",
		baseSpecies: "Croagunk",
		forme: "Lokura",
		types: ["Ground", "Grass"],
		baseStats: {hp: 56, atk: 63, def: 50, spa: 35, spd: 61, spe: 35},
		abilities: {0: "Anticipation", 1: "Rain Dish", H: "Poison Heal"},
		heightm: 0.7,
		weightkg: 7.8,
		color: "Green",
		evos: ["Toxicroak-Lokura"],
		eggGroups: ["Field"],
	},
	toxicroaklokura: {
		num: 454,
		name: "Toxicroak-Lokura",
		baseSpecies: "Toxicroak",
		forme: "Lokura",
		types: ["Ground", "Grass"],
		baseStats: {hp: 102, atk: 122, def: 70, spa: 60, spd: 88, spe: 80},
		abilities: {0: "Anticipation", 1: "Rain Dish", H: "Poison Heal"},
		heightm: 1.2,
		weightkg: 45.5,
		color: "Green",
		prevo: "Croagunk-Lokura",
		evoLevel: 35,
		eggGroups: ["Field"],
	},
	cucarecho: {
		...
		name: "Cucarecho",
		types: ["Bug", "Flying"],
		baseStats: {hp: 65, atk: 73, def: 84, spa: 100, spd: 81, spe: 112},
		abilities: {0: "Strong Winds", 1: "Cloud Nine", H: "Persistent"},
		heightm: 0.3,
		weightkg: 20,
		color: "White",
		eggGroups: ["Bug"],
	...
	fauntasma: {
		...
		name: "Fauntasma",
		types: ["Water", "Ghost"],
		baseStats: {hp: 60, atk: 85, def: 65, spa: 115, spd: 95, spe: 105},
		abilities: {0: "Rattled", 1: "Natural Cure", H: "Dancer"},
		heightm: 1.4,
		weightkg: 80,
		color: "Blue",
    ...
    name: "Wallo",
    types: ["Water"],
    baseStats: {hp: 58, atk: 77, def: 50, spa: 45, spd: 45, spe: 85},
    abilities: {0: "Poison Touch", 1: "Iron Fist", H: "Hydration"},
    heightm: 0.4,
    weightkg: 9,
    color: "Blue",
    evos: ["Jellop"],
    ...
    abilities: {0: "Hydration", 1: "Gordian Knot", H: "Regenerator"},
    heightm: 1.0,
    weightkg: 35,
    color: "Green",
    evos: ["Tangosta"],
	...
	tangosta: {
		...
		name: "Tangosta",
		types: ["Grass", "Dark"],
		baseStats: {hp: 95, atk: 70, def: 55, spa: 115, spd: 125, spe: 75},
		abilities: {0: "Berserk", 1: "Gordian Knot", H: "Regenerator"},
		heightm: 1.7,
		weightkg: 60,
		color: "Green",
		prevo: "Tangela-Lokura",
		evoLevel: 24,
		eggGroups: ["Grass", "Human-Like"],
		newmeta: "true",
	},
	tadpot: {
		...
		name: "Tadpot",
		types: ["Ground", "Psychic"],
		baseStats: {hp: 55, atk: 30, def: 65, spa: 75, spd: 80, spe: 30},
		abilities: {0: "Rain Dish", 1: "Bulletproof", H: "Solid Rock"},
		heightm: 0.9,
		weightkg: 46,
		color: "Brown",
	...
	delicidra: {
		...
		name: "Delicidra",
		types: ["Dragon", "Fairy"],
		baseStats: {hp: 88, atk: 112, def: 82, spa: 70, spd: 101, spe: 77},
	...
	servereign: {
		...
		name: "Servereign",
		types: ["Electric", "Psychic"],
		baseStats: {hp: 129, atk: 65, def: 55, spa: 112, spd: 112, spe: 27},
		abilities: {0: "Plus", 1: "Minus", H: "Analytic"},
		heightm: 3,
		weightkg: 70,
		color: "Blue",
		prevo: "Teramite",
	...
	teramite: {
		...
		name: "Teramite",
		types: ["Electric", "Psychic"],
		baseStats: {hp: 45, atk: 65, def: 55, spa: 72, spd: 62, spe: 57},
		abilities: {0: "Plus", 1: "Minus", H: "Download"},
		heightm: 0.2,
		weightkg: 1,
		color: "Blue",
		evos: ["Servereign"],
	...
	seelenite: {
		...
		name: "Seelenite",
		types: ["Rock", "Psychic"],
		baseStats: {hp: 77, atk: 85, def: 72, spa: 107, spd: 86, spe: 63},
		abilities: {0: "Seer", 1: "Clear Body", H: "Sheer Force"},
		heightm: 0.6,
		weightkg: 35,
		color: "Blue",
		eggGroups: ["Undiscovered"],
	...
	gluttoon: {
		...
		name: "Gluttoon",
		types: ["Normal", "Poison"],
		baseStats: {hp: 138, atk: 70, def: 86, spa: 88, spd: 78, spe: 40},
		abilities: {0: "Gluttony", 1: "Sticky Hold", H: "Greedy Gullet"},
		heightm: 1.2,
		weightkg: 38,
		color: "Purple",
		eggGroups: ["Field"],
	...
	chistral: {
		...
		name: "Chistral",
		types: ["Cosmic", "Flying"],
		baseStats: {hp: 70, atk: 35, def: 68, spa: 72, spd: 60, spe: 45},
		abilities: {0: "Thick Fat", 1: "Competitive", H: "Flare Boost"},
		heightm: 0.9,
		weightkg: 140,
		color: "Purple",
		evos: ["Pengestial"],
	...
	draconaut: {
		...
		name: "Draconaut",
		types: ["Electric", "Dragon"],
		baseStats: {hp: 92, atk: 75, def: 83, spa: 120, spd: 80, spe: 85},
		abilities: {0: "Propeller Tail", 1: "Storm Drain", H: "Mold Breaker"},
		heightm: 2.2,
		weightkg: 240,
		color: "Purple",
	...
	anistrake: {
		...
		name: "Anistrake",
		types: ["Dragon", "Bug"],
		baseStats: {hp: 105, atk: 100, def: 85, spa: 65, spd: 85, spe: 85},
		abilities: {0: "Tinted Lens", 1: "Hustle", H: "Last Stand"},
		heightm: 2.3,
		weightkg: 230,
		color: "Red",
	...
	warphuyen: {
		...
		name: "Warphuyen",
		types: ["Poison", "Fighting"],
		baseStats: {hp: 79, atk: 70, def: 111, spa: 110, spd: 80, spe: 70},
		abilities: {0: "Shell Armor", 1: "Sticky Hold", H: "Adaptability"},
		heightm: 1.6,
		weightkg: 201,
		color: "Green",
		eggGroups: ["Monster", "Field"],
	...
	galvaraffe: {
		...
		name: "Galvaraffe",
		types: ["Ground", "Electric"],
		baseStats: {hp: 85, atk: 107, def: 80, spa: 55, spd: 77, spe: 91},
		abilities: {0: "Oblivious", 1: "Sap Sipper", H: "Magnet Pull"},
		heightm: 5.2,
		weightkg: 500.8,
		color: "Yellow",
		eggGroups: ["Field"],
...
//	magnorillo: {
	...
	//	name: "Magnorillo",
	//	types: ["Rock", "Electric"],
	//	baseStats: {hp: 75, atk: 108, def: 91, spa: 51, spd: 105, spe: 98},
...
//	},
	dovamour: {
		...
		name: "Dovamour",
		types: ["Fairy", "Flying"],
		baseStats: {hp: 75, atk: 115, def: 80, spa: 75, spd: 80, spe: 105},
		abilities: {0: "Trace", 1: "Cute Charm", H: "Wonder Skin"},
		heightm: 1.9,
		weightkg: 80,
		color: "Blue",
	...
	dollet: {
		...
		name: "Dollet",
		types: ["Water", "Steel"],
		baseStats: {hp: 50, atk: 55, def: 30, spa: 85, spd: 30, spe: 85},
		abilities: {0: "Infiltrator", 1: "Rivalry", H: "Artillery"},
		heightm: 0.1,
		weightkg: 2,
		color: "Yellow",
		evos: ["Delphistol"],
	...
	delphistol: {
		...
		name: "Delphistol",
		types: ["Water", "Steel"],
		baseStats: {hp: 70, atk: 75, def: 70, spa: 131, spd: 70, spe: 72},
		abilities: {0: "Infiltrator", 1: "Rivalry", H: "Artillery"},
		heightm: 1.5,
		weightkg: 80,
		color: "Gray",
	...
	tangeling: {
		...
		name: "Tangeling",
		types: ["Grass"],
		baseStats: {hp: 45, atk: 25, def: 40, spa: 75, spd: 40, spe: 60},
		abilities: {0: "Chlorophyll", 1: "Gordian Knot", H: "Regenerator"},
		heightm: 0.3,
		weightkg: 10,
		color: "Green",
		evos: ["Tangela", "Tangela-Lokura"],
		eggGroups: ["Grass"],
		newmeta: "true",
	},
	denkyujin: {
...
//		types: ["Dragon", "Ghost"],
//		gender: "N",
//		baseStats: {hp: 76, atk: 90, def: 68, spa: 90, spd: 78, spe: 82},
//		abilities: {0: "Cosplay"},
//		heightm: 2.1,
//		weightkg: 35,
//		color: "Red",
...
//	lonestisedisguised: {
//		num: 10163,
//		name: "Lonestise-Disguised",
//		baseSpecies: "Lonestise",
//		forme: "Disguised",
//		types: ["Dragon", "Ghost"],
//		gender: "N",
//		baseStats: {hp: 76, atk: 68, def: 90, spa: 78, spd: 90, spe: 82},
//		abilities: {0: "Cosplay"},
//		heightm: 2.1,
//		weightkg: 35,
//		color: "Red",
...
nebuluga: {
	...
	gluttorow: {
		...
		name: "Gluttorow",
		types: ["Grass", "Dragon"],
		baseStats: {hp: 135, atk: 110, def: 80, spa: 65, spd: 70, spe: 80},
		abilities: {0: "Gluttony", 1: "Rough Skin", H: "Thick Fat"},
		heightm: 2.5,
		weightkg: 140,
		color: "Red",
	...
	tazelle: {
		...
		name: "Tazelle",
		types: ["Steel", "Electric"],
		baseStats: {hp: 65, atk: 97, def: 80, spa: 60, spd: 60, spe: 86},
		abilities: {0: "Dynamo", H: "Lightning Rod"},
		heightm: 1.4,
		weightkg: 37,
		color: "Gray",
		eggGroups: ["Field"],
	...
	grumpiglokura: {
		...
		forme: "Lokura",
		types: ["Dark"],
		baseStats: {hp: 80, atk: 65, def: 90, spa: 80, spd: 110, spe: 45},
		abilities: {0: "Technician", 1: "Adaptability", H: "Pickpocket"},
		heightm: 0.9,
		weightkg: 65.7,
		color: "Black",
		prevo: "Spoink",
	...
	bugaboogie: {
		...
		name: "Bugaboogie",
		types: ["Fairy", "Dark"],
		baseStats: {hp: 103, atk: 120, def: 73, spa: 107, spd: 107, spe: 90},
		abilities: {0: "Daunt", 1: "Overcoat", H: "Tough Claws"},
		heightm: 2.5,
		weightkg: 179,
		color: "Gray",
		eggGroups: ["Monster"],
	...
	sawcodil: {
		...
		name: "Sawcodil",
		types: ["Steel", "Grass"],
		baseStats: {hp: 75, atk: 140, def: 87, spa: 61, spd: 67, spe: 50},
		abilities: {0: "Sap Sipper", H: "Hyper Cutter"},
		heightm: 1.8,
		weightkg: 500,
		color: "Green",
		eggGroups: ["Monster"],
...
//		name: "Tundrago",
//		types: ["Ground", "Ice"],
//		baseStats: {hp: 75, atk: 126, def: 126, spa: 81, spd: 70, spe: 50},
//		abilities: {0: "Battle Armor", 1: "Snow Packing", H: "Ice Body"},
//		heightm: 5.1,
//		weightkg: 790,
//		color: "Blue",
//		eggGroups: ["Mineral", "Dragon"],
...
//	},
	tectaur: {
		...
		name: "Tectaur",
		types: ["Ground", "Dragon"],
		baseStats: {hp: 75, atk: 74, def: 77, spa: 103, spd: 66, spe: 75},
		abilities: {0: "Hydration", 1: "Shed Skin", H: "Overcoat"},
		heightm: 2.5,
		weightkg: 40,
		color: "Brown",
		eggGroups: ["Mineral", "Dragon"],
	...
	venomicore: {
		...
		name: "Venomicore",
		types: ["Cosmic", "Poison"],
		baseStats: {hp: 112, atk: 161, def: 95, spa: 100, spd: 110, spe: 102},
		abilities: {0: "Merciless", H: "Daunt"},
		heightm: 4.5,
		weightkg: 345,
		color: "Purple",
		eggGroups: ["Undiscovered"],
	...
	terrior: {
		...
		name: "Terrior",
		types: ["Ghost"],
		baseStats: {hp: 60, atk: 80, def: 70, spa: 85, spd: 75, spe: 101},
		abilities: {0: "Quick Feet", 1: "Reckless", H: "Remorse"},
		heightm: 0.4,
		weightkg: 22,
		color: "Black",
		eggGroups: ["Monster", "Field"],
	...
	faebletaur: {
		...
		name: "Faebletaur",
		types: ["Fairy", "Fighting"],
		baseStats: {hp: 95, atk: 116, def: 101, spa: 75, spd: 101, spe: 112},
		abilities: {0: "Defiant", 1: "Stalwart", H: "Tangling Hair"},
		heightm: 2.6,
		weightkg: 340,
		color: "Black",
		eggGroups: ["Monster", "Field"],
	...
	joebiden: {
		...
		name: "Joe-Biden",
		types: ["Normal"],
		baseStats: {hp: 60, atk: 60, def: 60, spa: 60, spd: 5, spe: 60},
		abilities: {0: "Fish Memory"},
		heightm: 1.8,
		weightkg: 97,
		color: "White",
		eggGroups: ["Field", "Human-Like"],
	...
	prikall: {
		...
		name: "Prikall",
		types: ["Normal"],
		baseStats: {hp: 50, atk: 35, def: 50, spa: 25, spd: 50, spe: 30},
		abilities: {0: "Soundproof", 1: "Rough Skin", H: "Rattled"},
		heightm: 0.2,
		weightkg: 10,
		color: "Gray",
		evos: ["Mespine"],
	...
	mespine: {
		...
		name: "Mespine",
		types: ["Normal", "Steel"],
		baseStats: {hp: 70, atk: 85, def: 110, spa: 50, spd: 70, spe: 55},
		abilities: {0: "Soundproof", 1: "Iron Barbs", H: "Vicarious"},
		heightm: 1.1,
		weightkg: 100,
		color: "Gray",
		prevo: "Prikall",
	...
	gauchomander: {
		...
		name: "Gauchomander",
		types: ["Fire", "Ground"],
		baseStats: {hp: 82, atk: 109, def: 72, spa: 99, spd: 72, spe: 101},
		abilities: {0: "Sniper", 1: "Overcoat", H: "Inner Focus"},
		heightm: 1.7,
		weightkg: 48,
		color: "Brown",
	...
	velonadon: {
		...
		name: "Velonadon",
		types: ["Bug", "Dragon"],
		baseStats: {hp: 97, atk: 177, def: 83, spa: 121, spd: 88, spe: 115},
		abilities: {0: "Anger Point", H: "Compound Eyes"},
		heightm: 22.4,
		weightkg: 390,
		color: "Black",
		eggGroups: ["Undiscovered"],
	...
	neglecrow: {
		...
		name: "Neglecrow",
		types: ["Dark", "Flying"],
		baseStats: {hp: 85, atk: 95, def: 70, spa: 85, spd: 70, spe: 95},
		abilities: {0: "Infiltrator", 1: "Pickpocket", H: "Oblivious"},
		heightm: 3.9,
		weightkg: 30,
		color: "Brown",
		prevo: "Moochick",
	...
	pyroterois: {
		...
		name: "Pyroterois",
		types: ["Fire", "Water"],
		baseStats: {hp: 100, atk: 112, def: 62, spa: 62, spd: 100, spe: 84},
		abilities: {0: "Cauterize", 1: "Steam Power", H: "Flame Body"},
		heightm: 0.9,
		weightkg: 19.6,
		color: "Red",
		eggGroups: ["Water 2"],
	...
	ratautumn: {
		...
		name: "Ratautumn",
		types: ["Grass", "Fairy"],
		baseStats: {hp: 75, atk: 42, def: 100, spa: 61, spd: 112, spe: 120},
		abilities: {0: "Cheek Pouch", H: "Grassy Surge"},
		heightm: 1.04,
		weightkg: 8.1,
		color: "Brown",
		eggGroups: ["Field"],
	...
	bikkubear: {
		...
		types: ["Fire"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 50, atk: 55, def: 50, spa: 60, spd: 50, spe: 40},
		abilities: {0: "Blaze", 1: "Herbivore", H: "Serene Grace"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Red",
		evos: ["Bonfaya"],
	...
	bonfaya: {
		...
		types: ["Fire", "Light"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 80, atk: 70, def: 70, spa: 80, spd: 70, spe: 50},
		abilities: {0: "Blaze", 1: "Herbivore", H: "Serene Grace"},
		heightm: 1.1,
		weightkg: 19,
		color: "Red",
	...
	calvana: {
		...
		types: ["Fire", "Light"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 90, atk: 92, def: 92, spa: 109, spd: 92, spe: 60},
		abilities: {0: "Blaze", 1: "Herbivore", H: "Serene Grace"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Red",
	...
	caporaptor: {
		...
		baseStats: {hp: 65, atk: 99, def: 75, spa: 81, spd: 79, spe: 119},
		abilities: {0: "Kicker", 1: "Dancer", H: "Limber"},
		heightm: 1.7,
		weightkg: 97.2,
		color: "Brown",
	...
	jumplufforre: {
		...
		forme: "Orre",
		types: ["Grass", "Ghost"],
		baseStats: {hp: 65, atk: 55, def: 95, spa: 90, spd: 80, spe: 110},
		abilities: {0: "Cotton Down", 1: "Cursed Body", H: "Prankster"},
		heightm: 2,
		weightkg: 82,
		color: "Black",
		prevo: "Skiploom",
	...
	bunnula: {
		...
		name: "Bunnula",
		types: ["Cosmic", "Ground"],
		baseStats: {hp: 40, atk: 42, def: 42, spa: 42, spd: 82, spe: 82},
		abilities: {0: "Run Away", 1: "Supernova", H: "Shield Dust"},
		heightm: 0.3,
		weightkg: 0.1,
		color: "Gray",
		evos: ["Lepanova"],
	...
	lepanova: {
		...
		name: "Lepanova",
		types: ["Cosmic", "Ground"],
		baseStats: {hp: 70, atk: 108, def: 62, spa: 62, spd: 82, spe: 122},
		abilities: {0: "Sand Force", 1: "Supernova", H: "Shield Dust"},
		heightm: 1.1,
		weightkg: 40,
		color: "Gray",
		prevo: "Bunnula",
	...
	icicroak: {
		...
		name: "Icicroak",
		types: ["Ice"],
		baseStats: {hp: 40, atk: 46, def: 80, spa: 95, spd: 40, spe: 54},
	...
	rascleaf: {
		...
		types: ["Grass", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 44, atk: 43, def: 50, spa: 61, spd: 44, spe: 68},
		abilities: {0: "Overgrow", 1: "Pickpocket", H: "Filter"},
		heightm: 0.6,
		weightkg: 8.5,
		color: "Green",
		evos: ["breezeaf"],
	...
	breezeaf: {
		...
		types: ["Grass", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 60, atk: 82, def: 60, spa: 80, spd: 60, spe: 78},
		abilities: {0: "Overgrow", 1: "Pickpocket", H: "Filter"},
		heightm: 1.1,
		weightkg: 19,
		color: "Green",
	...
	soarustle: {
		...
		types: ["Grass", "Flying"],
		genderRatio: {M: 0.875, F: 0.125},
		baseStats: {hp: 92, atk: 78, def: 80, spa: 119, spd: 80, spe: 86},
		abilities: {0: "Overgrow", 1: "Pickpocket", H: "Filter"},
		heightm: 1.7,
		weightkg: 90.5,
		color: "Green",
	...
	doodbird: {
		...
		name: "Doodbird",
		types: ["Fighting", "Flying"],
		baseStats: {hp: 70, atk: 100, def: 75, spa: 65, spd: 65, spe: 95},
		abilities: {0: "Swift Swim", 1: "Tangled Feet", H: "Oblivious"},
		heightm: 1.06,
		weightkg: 7.1,
		color: "Brown",
		eggGroups: ["Flying", "Human-Like"],
	...
	pintherata: {
		...
		name: "Pintherata",
		types: ["Fairy", "Steel"],
		baseStats: {hp: 71, atk: 111, def: 99, spa: 55, spd: 98, spe: 111},
		abilities: {0: "Rattled", 1: "No Guard", H: "Innards Out"},
		heightm: 1.6,
		weightkg: 120,
		color: "Yellow",
		eggGroups: ["Fairy","Field"],
	...
	licoroller: {
		...
		name: "Licoroller",
		types: ["Poison", "Dark"],
		baseStats: {hp: 115, atk: 90, def: 90, spa: 90, spd: 90, spe: 50},
		abilities: {0: "Liquid Ooze", 1: "Steadfast", H: "Speed Boost"},
		heightm: 1.06,
		weightkg: 26.3,
		color: "Black",
		eggGroups: ["Amorphous"],
	...
	chilladder: {
		...
		name: "Chilladder",
		types: ["Ice"],
		baseStats: {hp: 46, atk: 74, def: 46, spa: 64, spd: 46, spe: 60},
		abilities: {0: "Mountaineer", 1: "Slush Rush", H: "Shed Skin"},
		heightm: 0.4,
		weightkg: 12.8,
		color: "White",
		evos: ["Alpython"],
	...
	alpython: {
		...
		name: "Alpython",
		types: ["Ice", "Dragon"],
		baseStats: {hp: 73, atk: 112, def: 73, spa: 102, spd: 73, spe: 100},
		abilities: {0: "Mountaineer", 1: " Slush Rush", H: "Shed Skin"},
		heightm: 5.6,
		weightkg: 222,
		color: "White",
	...
	gulava: {
		...
		name: "Gulava",
		types: ["Fire", "Flying"],
		baseStats: {hp: 50, atk: 40, def: 60, spa: 70, spd: 30, spe: 40},
		abilities: {0: "Ignition", 1: "Cauterize", H: "Klutz"},
		heightm: 0.5,
		weightkg: 20,
		color: "White",
		evos: ["Pelikiln"],
	...
	pelikiln: {
		...
		name: "Pelikiln",
		types: ["Fire", "Flying"],
		baseStats: {hp: 90, atk: 70, def: 80, spa: 104, spd: 90, spe: 84},
		abilities: {0: "Ignition", 1: "Cauterize", H: "Prankster"},
		heightm: 1,
		weightkg: 67,
		color: "White",
		prevo: "Gulava",
...
//		name: "Komonger",
//		types: ["Steel"],
//		baseStats: {hp: 71, atk: 75, def: 110, spa: 80, spd: 90, spe: 102},
//		abilities: {0: "Battle Armor", 1: "Hustle", H: "Sheer Force"},
//		heightm: 5.4,
//		weightkg: 600.3,
//		color: "White",
//		eggGroups: ["Mineral", "Dragon"],
...
//	},
	baobital: {
		...
		name: "Baobital",
		types: ["Grass", "Cosmic"],
		baseStats: {hp: 120, atk: 50, def: 78, spa: 80, spd: 72, spe: 60},
		abilities: {0: "Seer", 1: "Telepathy", H: "Run Away"},
		heightm: 18.6,
		weightkg: 270.1,
		color: "Brown",
		eggGroups: ["Grass"],
	...
	roselisk: {
		...
		name: "Roselisk",
		types: ["Fire", "Grass"],
		baseStats: {hp: 88, atk: 120, def: 85, spa: 55, spd: 85, spe: 97},
		abilities: {0: "Ignition", 1: "Conflagrant", H: "Sunbathe"},
		heightm: 2.5,
		weightkg: 510.7,
		color: "Red",
		eggGroups: ["Dragon","Grass"],
		...
		falcaero: {
			...
			name: "Falcaero",
			types: ["Flying"],
			baseStats: {hp: 80, atk: 100, def: 85, spa: 46, spd: 80, spe: 109},
			abilities: {0: "Aerilate", 1: "Limber", H: "Protean"},
			heightm: 1.6,
			weightkg: 80,
			color: "Grey",
			eggGroups: ["Human-Like"],
		...
		sussew: {
			...
			name: "Sussew",
			types: ["Ghost"],
			baseStats: {hp: 124, atk: 107, def: 67, spa: 80, spd: 77, spe: 55},
			abilities: {0: "Remorse", 1: "Cursed Body", H: "Fluffy"},
			heightm: 1.7,
			weightkg: 108,
			color: "Grey",
			eggGroups: ["Monster"],
			...
			osteolortal: {
				...
				name: "Osteolortal",
				types: ["Cosmic", "Ghost"],
				baseStats: {hp: 102, atk: 106, def: 76, spa: 49, spd: 92, spe: 100},
				abilities: {0: "Iron Fist", 1: "Wise Power", H: "Breakneck"},
				heightm: 3.4,
				weightkg: 56,
				color: "Purple",
				eggGroups: ["Dragon","Water 2"],
		...
		tombsbone: {
				...
				types: ["Rock", "Ghost"],
				gender: "N",
				baseStats: {hp: 100, atk: 70, def: 70, spa: 85, spd: 80, spe: 20},
...
headsbone: {
				...
				types: ["Rock", "Ghost"],
				gender: "N",
				baseStats: {hp: 120, atk: 80, def: 85, spa: 105, spd: 95, spe: 35},
				abilities: {0: "Cursed Body", H: "Solid Rock"},
				heightm: 2.4,
				weightkg: 104,
				color: "Gray",
	...
	name: "Commocto",
	types: ["Water", "Fighting"],
	baseStats: {hp: 120, atk: 95, def: 85, spa: 125, spd: 85, spe: 35},
	abilities: {0: "Suction Cups", 1: "Sniper", H: "Artillery"},
	heightm: 1.3,
	weightkg: 89,
	color: "Red",
	...
	immarsh: {
		...
		baseStats: {hp: 82, atk: 110, def: 90, spa: 85, spd: 81, spe: 51},
		abilities: {0: "Poison Touch", 1: "Galvanize", H: "Regenerator"},
		heightm: 1.6,
		weightkg: 92,
		color: "Green",
		eggGroups: ["Monster"],
	...
	jacrackle: {
		...
		name: "Jacrackle",
		types: ["Grass", "Fire"],
		baseStats: {hp: 90, atk: 31, def: 91, spa: 104, spd: 89, spe: 84},
		abilities: {0: "Rough Skin", 1: "Breakneck", H: "Hubris"},
		heightm: 0.4,
		weightkg: 12,
		color: "Red",
		eggGroups: ["Monster", "Grass"],
	...
	catterbox: {
		...
		types: ["Fairy"],
		baseStats: {hp: 41, atk: 64, def: 45, spa: 50, spd: 50, spe: 50},
		abilities: {0: "No Guard", 1: "Defiant", H: "Super Luck"},
		heightm: 0.4,
		weightkg: 0.1,
		color: "Pink",
		evos: ["Gouzigami"],
	...
	orizuian: {
		...
		name: "Orizuian",
		types: ["Fairy", "Rock"],
		baseStats: {hp: 84, atk: 110, def: 65, spa: 120, spd: 70, spe: 106},
		abilities: {0: "No Guard", 1: "Defiant", H: "Levitate"},
		heightm: 1.6,
		weightkg: 40,
		color: "Pink",
		prevo: "Gouzigami",
